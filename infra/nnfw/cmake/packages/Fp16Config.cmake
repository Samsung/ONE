function(_Fp16_Build)
  ...
  set(FP16_BUILD_TESTS
      OFF
      CACHE BOOL "Build FP16 unit tests")
  set(FP16_BUILD_BENCHMARKS
      OFF
      CACHE BOOL "Build FP16 micro-benchmarks")
  nnas_find_package(PsimdSource)
  set(PSIMD_SOURCE_DIR
      ${PsimdSource_DIR}
      CACHE STRING "String to disable download PSIMD on fp16")
