function(_Pthreadpool_Build)
  ...
  if(TARGET pthreadpool)
    set(PthreadpoolSource_DIR
        ${PthreadpoolSource_DIR}
        PARENT_SCOPE)
    set(Pthreadpool_FOUND
        TRUE
        PARENT_SCOPE)
    return()
  ...
  SET(PTHREADPOOL_BUILD_TESTS
      OFF
      CACHE BOOL "Build pthreadpool unit tests")
  SET(PTHREADPOOL_BUILD_BENCHMARKS
      OFF
      CACHE BOOL "Build pthreadpool micro-benchmarks")

  nnas_find_package(FxdivSource)
  set(FXDIV_SOURCE_DIR
      ${FxdivSource_DIR}
      CACHE STRING "String to disable download FXDIV")
