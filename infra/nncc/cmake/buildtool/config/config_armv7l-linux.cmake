...
set(FLAGS_COMMON ${FLAGS_COMMON} "-march=armv7-a" "-mtune=cortex-a8" "-mfloat-abi=hard" "-mfp16-format=ieee")

if(BUILD_ARM32_NEON)
  set(FLAGS_COMMON ${FLAGS_COMMON} "-mfpu=vfpv3-d16" "-ftree-vectorize")
