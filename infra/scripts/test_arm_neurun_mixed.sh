...
SKIPLIST_PREFIX="Product/out/unittest/nnapi_gtest.skip.armv7l-linux"
...
Unittests "acl_cl;acl_neon;cpu" "Product/out/unittest/nnapi_gtest.skip.armv7l-linux.union" "report/mixed"
