function(_LLVM_import)
  ...
  if(NOT TARGET llvm)
    ...
    execute_process(
      ...
      OUTPUT_VARIABLE LLVM_CPPFLAGS_STR
    ...
    execute_process(
      ...
      OUTPUT_VARIABLE LLVM_LINKFLAGS
      OUTPUT_STRIP_TRAILING_WHITESPACE)
    execute_process(
      COMMAND ${llvm_config} --system-libs
      OUTPUT_VARIABLE LLVM_LINKSYSLIBS
      OUTPUT_STRIP_TRAILING_WHITESPACE)
    execute_process(
      COMMAND ${llvm_config} --libs core mcjit native
      OUTPUT_VARIABLE LLVM_LINKLIBS
      OUTPUT_STRIP_TRAILING_WHITESPACE)
