...
set(ARM_NONE_EABI_GCC_TOOLCHAIN_PATH "${CMAKE_BINARY_DIR}/externals/gcc-arm-none-eabi-9-2020-q2-update")
...
if (NOT EXISTS "${ARM_NONE_EABI_GCC_TOOLCHAIN_PATH}")
  ...
  execute_process(COMMAND tar -xjf "${ARM_NONE_EABI_GCC_TOOLCHAIN_PATH}.tar.bz2" -C "${CMAKE_BINARY_DIR}/externals")
