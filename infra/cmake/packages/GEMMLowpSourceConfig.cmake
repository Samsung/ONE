function(_GEMMLowpSource_import)
  ...
  envoption(GEMMLOWP_URL
            ${EXTERNAL_DOWNLOAD_SERVER}/google/gemmlowp/archive/38ebac7b059e84692f53e5938f97a9943c120d98.tar.gz)

  ExternalSource_Download(GEMMLOWP ${GEMMLOWP_URL})

  set(GEMMLowpSource_DIR
      ${GEMMLOWP_SOURCE_DIR}
      PARENT_SCOPE)
  set(GEMMLowpSource_FOUND
      TRUE
