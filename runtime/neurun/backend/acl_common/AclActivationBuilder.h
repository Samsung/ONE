...
#ifndef __NEURUN_BACKEND_ACL_COMMON_ACL_ACTIVATION_BUILDER_H__
#define __NEURUN_BACKEND_ACL_COMMON_ACL_ACTIVATION_BUILDER_H__
...
#endif // __NEURUN_BACKEND_ACL_COMMON_ACL_ACTIVATION_BUILDER_H__
