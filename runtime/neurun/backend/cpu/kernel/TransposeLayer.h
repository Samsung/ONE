...
#ifndef __NEURUN_BACKEND_CPU_KERNEL_TRANSPOSELAYER_H__
...
class TransposeLayer : public ::neurun::exec::IFunction
{
public:
  TransposeLayer();
...
#endif // __NEURUN_BACKEND_CPU_KERNEL_TRANSPOSELAYER_H__
