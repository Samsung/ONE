...
#ifndef __NEURUN_BACKEND_CPU_KERNEL_DIVLAYER_H__
#define __NEURUN_BACKEND_CPU_KERNEL_DIVLAYER_H__
...
class DivLayer : public ::neurun::exec::IFunction
{
public:
...
#endif // __NEURUN_BACKEND_CPU_KERNEL_DIVLAYER_H__
