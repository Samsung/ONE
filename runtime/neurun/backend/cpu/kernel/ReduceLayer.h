...
#ifndef __NEURUN_BACKEND_CPU_KERNEL_REDUCESUMLAYER_H__
#define __NEURUN_BACKEND_CPU_KERNEL_REDUCESUMLAYER_H__
...
class ReduceLayer : public ::neurun::exec::IFunction
{
public:
  ReduceLayer();
  ~ReduceLayer();
...
#endif // __NEURUN_BACKEND_CPU_KERNEL_REDUCESUMLAYER_H__
