...
#ifndef __NEURUN_BACKEND_CPU_KERNEL_SLICELAYER_H__
#define __NEURUN_BACKEND_CPU_KERNEL_SLICELAYER_H__
...
class SliceLayer : public ::neurun::exec::IFunction
{
public:
  SliceLayer();
...
#endif // __NEURUN_BACKEND_CPU_KERNEL_SLICELAYER_H__
