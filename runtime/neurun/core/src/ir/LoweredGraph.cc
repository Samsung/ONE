...
OpSequenceIndex LoweredGraph::appendFreshSingleOpSubgraph(const OperationIndex &node_index,
    ...
    const compiler::CompilerOptions &options)
{
  ...
  PostDfsConstIterator{}.iterate(
      _graph, [&](const OperationIndex &node_index, const Operation &node) {
        ...
        {
          auto new_op_seq_index = appendFreshSingleOpSubgraph(node_index, node, frontend_layout);
