...
#ifndef __NEURUN_IR_PASS_LOWERED_OPERATION_PASS_H__
#define __NEURUN_IR_PASS_LOWERED_OPERATION_PASS_H__
...
public:
  ...
  virtual void callback(const OperationIndex &i, Operation &o) = 0;
...
#endif // __NEURUN_IR_PASS_LOWERED_OPERATION_PASS_H__
