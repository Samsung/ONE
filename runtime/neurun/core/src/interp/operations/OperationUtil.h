...
#ifndef __NEURUN_INTERP_OPERATIONS_OPERATION_UTILS_H_
#define __NEURUN_INTERP_OPERATIONS_OPERATION_UTILS_H_
...
#endif // __NEURUN_INTERP_OPERATIONS_OPERATION_UTILS_H_
