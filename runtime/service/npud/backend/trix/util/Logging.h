...
#ifndef __ONE_SERVICE_NPUD_BACKEND_TRIX_UTIL_LOGGING_H__
#define __ONE_SERVICE_NPUD_BACKEND_TRIX_UTIL_LOGGING_H__
...
#define VERBOSE(name)                                      \
  if (::npud::backend::trix::util::logging::ctx.enabled()) \
  std::cout << ::npud::backend::trix::util::logging::decorated_name(#name)

#define VERBOSE_F()                                        \
  if (::npud::backend::trix::util::logging::ctx.enabled()) \
  std::cout << ::npud::backend::trix::util::logging::decorated_name(__func__)
...
#endif // __ONE_SERVICE_NPUD_BACKEND_TRIX_UTIL_LOGGING_H__
