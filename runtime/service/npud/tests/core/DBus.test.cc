...
TEST_F(DBusTest, context_destroy_invalid_ctx_NEG)
{
  NpudCore *proxy = this->getProxy();
  ASSERT_NE(proxy, nullptr);
...
TEST_F(DBusTest, request_create_invalid_ctx_NEG)
{
  NpudCore *proxy = this->getProxy();
  ASSERT_NE(proxy, nullptr);
...
TEST_F(DBusTest, request_create_invalid_nw_NEG)
{
  NpudCore *proxy = this->getProxy();
  ASSERT_NE(proxy, nullptr);
...
TEST_F(DBusTest, request_destroy_invalid_ctx_NEG)
{
  NpudCore *proxy = this->getProxy();
  ASSERT_NE(proxy, nullptr);
