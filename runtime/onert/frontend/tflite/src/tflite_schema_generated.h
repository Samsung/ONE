...
#ifndef FLATBUFFERS_GENERATED_TFLITESCHEMA_TFLITE_H_
#define FLATBUFFERS_GENERATED_TFLITESCHEMA_TFLITE_H_
...
struct QuantizationDetailsUnion
{
  ...
  onert_tflite::CustomQuantizationT *AsCustomQuantization()
  {
    return type == QuantizationDetails_CustomQuantization
             ? reinterpret_cast<onert_tflite::CustomQuantizationT *>(value)
             : nullptr;
  }
  const onert_tflite::CustomQuantizationT *AsCustomQuantization() const
  {
    return type == QuantizationDetails_CustomQuantization
             ? reinterpret_cast<const onert_tflite::CustomQuantizationT *>(value)
             : nullptr;
  }
};
...
struct SparseIndexVectorUnion
{
  ...
  onert_tflite::Int32VectorT *AsInt32Vector()
  {
    return type == SparseIndexVector_Int32Vector
             ? reinterpret_cast<onert_tflite::Int32VectorT *>(value)
             : nullptr;
  }
  const onert_tflite::Int32VectorT *AsInt32Vector() const
  {
    return type == SparseIndexVector_Int32Vector
             ? reinterpret_cast<const onert_tflite::Int32VectorT *>(value)
             : nullptr;
  }
  onert_tflite::Uint16VectorT *AsUint16Vector()
  {
    return type == SparseIndexVector_Uint16Vector
             ? reinterpret_cast<onert_tflite::Uint16VectorT *>(value)
             : nullptr;
  }
  const onert_tflite::Uint16VectorT *AsUint16Vector() const
  {
    return type == SparseIndexVector_Uint16Vector
             ? reinterpret_cast<const onert_tflite::Uint16VectorT *>(value)
             : nullptr;
  }
  onert_tflite::Uint8VectorT *AsUint8Vector()
  {
    return type == SparseIndexVector_Uint8Vector
             ? reinterpret_cast<onert_tflite::Uint8VectorT *>(value)
             : nullptr;
  }
  const onert_tflite::Uint8VectorT *AsUint8Vector() const
  {
    return type == SparseIndexVector_Uint8Vector
             ? reinterpret_cast<const onert_tflite::Uint8VectorT *>(value)
             : nullptr;
  }
};
...
{
  static const char *const names[146] = {"ADD",
                                         "AVERAGE_POOL_2D",
                                         "CONCATENATION",
                                         "CONV_2D",
                                         "DEPTHWISE_CONV_2D",
...
{
  if (flatbuffers::IsOutRange(e, BuiltinOperator_ADD, BuiltinOperator_ASSIGN_VARIABLE))
    return "";
  const size_t index = static_cast<size_t>(e);
...
{
  static const char *const names[115] = {"NONE",
                                         "Conv2DOptions",
...
{
  if (flatbuffers::IsOutRange(e, BuiltinOptions_NONE, BuiltinOptions_AssignVariableOptions))
    return "";
  const size_t index = static_cast<size_t>(e);
...
struct BuiltinOptionsUnion
{
  ...
  onert_tflite::Conv2DOptionsT *AsConv2DOptions()
  {
    return type == BuiltinOptions_Conv2DOptions
             ? reinterpret_cast<onert_tflite::Conv2DOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::Conv2DOptionsT *AsConv2DOptions() const
  {
    return type == BuiltinOptions_Conv2DOptions
             ? reinterpret_cast<const onert_tflite::Conv2DOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::DepthwiseConv2DOptionsT *AsDepthwiseConv2DOptions()
  {
    return type == BuiltinOptions_DepthwiseConv2DOptions
             ? reinterpret_cast<onert_tflite::DepthwiseConv2DOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::DepthwiseConv2DOptionsT *AsDepthwiseConv2DOptions() const
  {
    return type == BuiltinOptions_DepthwiseConv2DOptions
             ? reinterpret_cast<const onert_tflite::DepthwiseConv2DOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ConcatEmbeddingsOptionsT *AsConcatEmbeddingsOptions()
  {
    return type == BuiltinOptions_ConcatEmbeddingsOptions
             ? reinterpret_cast<onert_tflite::ConcatEmbeddingsOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ConcatEmbeddingsOptionsT *AsConcatEmbeddingsOptions() const
  {
    return type == BuiltinOptions_ConcatEmbeddingsOptions
             ? reinterpret_cast<const onert_tflite::ConcatEmbeddingsOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::LSHProjectionOptionsT *AsLSHProjectionOptions()
  {
    return type == BuiltinOptions_LSHProjectionOptions
             ? reinterpret_cast<onert_tflite::LSHProjectionOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::LSHProjectionOptionsT *AsLSHProjectionOptions() const
  {
    return type == BuiltinOptions_LSHProjectionOptions
             ? reinterpret_cast<const onert_tflite::LSHProjectionOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::Pool2DOptionsT *AsPool2DOptions()
  {
    return type == BuiltinOptions_Pool2DOptions
             ? reinterpret_cast<onert_tflite::Pool2DOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::Pool2DOptionsT *AsPool2DOptions() const
  {
    return type == BuiltinOptions_Pool2DOptions
             ? reinterpret_cast<const onert_tflite::Pool2DOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SVDFOptionsT *AsSVDFOptions()
  {
    return type == BuiltinOptions_SVDFOptions
             ? reinterpret_cast<onert_tflite::SVDFOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SVDFOptionsT *AsSVDFOptions() const
  {
    return type == BuiltinOptions_SVDFOptions
             ? reinterpret_cast<const onert_tflite::SVDFOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::RNNOptionsT *AsRNNOptions()
  {
    return type == BuiltinOptions_RNNOptions ? reinterpret_cast<onert_tflite::RNNOptionsT *>(value)
                                             : nullptr;
  }
  const onert_tflite::RNNOptionsT *AsRNNOptions() const
  {
    return type == BuiltinOptions_RNNOptions
             ? reinterpret_cast<const onert_tflite::RNNOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::FullyConnectedOptionsT *AsFullyConnectedOptions()
  {
    return type == BuiltinOptions_FullyConnectedOptions
             ? reinterpret_cast<onert_tflite::FullyConnectedOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::FullyConnectedOptionsT *AsFullyConnectedOptions() const
  {
    return type == BuiltinOptions_FullyConnectedOptions
             ? reinterpret_cast<const onert_tflite::FullyConnectedOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SoftmaxOptionsT *AsSoftmaxOptions()
  {
    return type == BuiltinOptions_SoftmaxOptions
             ? reinterpret_cast<onert_tflite::SoftmaxOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SoftmaxOptionsT *AsSoftmaxOptions() const
  {
    return type == BuiltinOptions_SoftmaxOptions
             ? reinterpret_cast<const onert_tflite::SoftmaxOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ConcatenationOptionsT *AsConcatenationOptions()
  {
    return type == BuiltinOptions_ConcatenationOptions
             ? reinterpret_cast<onert_tflite::ConcatenationOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ConcatenationOptionsT *AsConcatenationOptions() const
  {
    return type == BuiltinOptions_ConcatenationOptions
             ? reinterpret_cast<const onert_tflite::ConcatenationOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::AddOptionsT *AsAddOptions()
  {
    return type == BuiltinOptions_AddOptions ? reinterpret_cast<onert_tflite::AddOptionsT *>(value)
                                             : nullptr;
  }
  const onert_tflite::AddOptionsT *AsAddOptions() const
  {
    return type == BuiltinOptions_AddOptions
             ? reinterpret_cast<const onert_tflite::AddOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::L2NormOptionsT *AsL2NormOptions()
  {
    return type == BuiltinOptions_L2NormOptions
             ? reinterpret_cast<onert_tflite::L2NormOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::L2NormOptionsT *AsL2NormOptions() const
  {
    return type == BuiltinOptions_L2NormOptions
             ? reinterpret_cast<const onert_tflite::L2NormOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::LocalResponseNormalizationOptionsT *AsLocalResponseNormalizationOptions()
  {
    return type == BuiltinOptions_LocalResponseNormalizationOptions
             ? reinterpret_cast<onert_tflite::LocalResponseNormalizationOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::LocalResponseNormalizationOptionsT *
  AsLocalResponseNormalizationOptions() const
  {
    return type == BuiltinOptions_LocalResponseNormalizationOptions
             ? reinterpret_cast<const onert_tflite::LocalResponseNormalizationOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::LSTMOptionsT *AsLSTMOptions()
  {
    return type == BuiltinOptions_LSTMOptions
             ? reinterpret_cast<onert_tflite::LSTMOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::LSTMOptionsT *AsLSTMOptions() const
  {
    return type == BuiltinOptions_LSTMOptions
             ? reinterpret_cast<const onert_tflite::LSTMOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ResizeBilinearOptionsT *AsResizeBilinearOptions()
  {
    return type == BuiltinOptions_ResizeBilinearOptions
             ? reinterpret_cast<onert_tflite::ResizeBilinearOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ResizeBilinearOptionsT *AsResizeBilinearOptions() const
  {
    return type == BuiltinOptions_ResizeBilinearOptions
             ? reinterpret_cast<const onert_tflite::ResizeBilinearOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::CallOptionsT *AsCallOptions()
  {
    return type == BuiltinOptions_CallOptions
             ? reinterpret_cast<onert_tflite::CallOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::CallOptionsT *AsCallOptions() const
  {
    return type == BuiltinOptions_CallOptions
             ? reinterpret_cast<const onert_tflite::CallOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ReshapeOptionsT *AsReshapeOptions()
  {
    return type == BuiltinOptions_ReshapeOptions
             ? reinterpret_cast<onert_tflite::ReshapeOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ReshapeOptionsT *AsReshapeOptions() const
  {
    return type == BuiltinOptions_ReshapeOptions
             ? reinterpret_cast<const onert_tflite::ReshapeOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SkipGramOptionsT *AsSkipGramOptions()
  {
    return type == BuiltinOptions_SkipGramOptions
             ? reinterpret_cast<onert_tflite::SkipGramOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SkipGramOptionsT *AsSkipGramOptions() const
  {
    return type == BuiltinOptions_SkipGramOptions
             ? reinterpret_cast<const onert_tflite::SkipGramOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SpaceToDepthOptionsT *AsSpaceToDepthOptions()
  {
    return type == BuiltinOptions_SpaceToDepthOptions
             ? reinterpret_cast<onert_tflite::SpaceToDepthOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SpaceToDepthOptionsT *AsSpaceToDepthOptions() const
  {
    return type == BuiltinOptions_SpaceToDepthOptions
             ? reinterpret_cast<const onert_tflite::SpaceToDepthOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::EmbeddingLookupSparseOptionsT *AsEmbeddingLookupSparseOptions()
  {
    return type == BuiltinOptions_EmbeddingLookupSparseOptions
             ? reinterpret_cast<onert_tflite::EmbeddingLookupSparseOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::EmbeddingLookupSparseOptionsT *AsEmbeddingLookupSparseOptions() const
  {
    return type == BuiltinOptions_EmbeddingLookupSparseOptions
             ? reinterpret_cast<const onert_tflite::EmbeddingLookupSparseOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::MulOptionsT *AsMulOptions()
  {
    return type == BuiltinOptions_MulOptions ? reinterpret_cast<onert_tflite::MulOptionsT *>(value)
                                             : nullptr;
  }
  const onert_tflite::MulOptionsT *AsMulOptions() const
  {
    return type == BuiltinOptions_MulOptions
             ? reinterpret_cast<const onert_tflite::MulOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::PadOptionsT *AsPadOptions()
  {
    return type == BuiltinOptions_PadOptions ? reinterpret_cast<onert_tflite::PadOptionsT *>(value)
                                             : nullptr;
  }
  const onert_tflite::PadOptionsT *AsPadOptions() const
  {
    return type == BuiltinOptions_PadOptions
             ? reinterpret_cast<const onert_tflite::PadOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::GatherOptionsT *AsGatherOptions()
  {
    return type == BuiltinOptions_GatherOptions
             ? reinterpret_cast<onert_tflite::GatherOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::GatherOptionsT *AsGatherOptions() const
  {
    return type == BuiltinOptions_GatherOptions
             ? reinterpret_cast<const onert_tflite::GatherOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::BatchToSpaceNDOptionsT *AsBatchToSpaceNDOptions()
  {
    return type == BuiltinOptions_BatchToSpaceNDOptions
             ? reinterpret_cast<onert_tflite::BatchToSpaceNDOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::BatchToSpaceNDOptionsT *AsBatchToSpaceNDOptions() const
  {
    return type == BuiltinOptions_BatchToSpaceNDOptions
             ? reinterpret_cast<const onert_tflite::BatchToSpaceNDOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SpaceToBatchNDOptionsT *AsSpaceToBatchNDOptions()
  {
    return type == BuiltinOptions_SpaceToBatchNDOptions
             ? reinterpret_cast<onert_tflite::SpaceToBatchNDOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SpaceToBatchNDOptionsT *AsSpaceToBatchNDOptions() const
  {
    return type == BuiltinOptions_SpaceToBatchNDOptions
             ? reinterpret_cast<const onert_tflite::SpaceToBatchNDOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::TransposeOptionsT *AsTransposeOptions()
  {
    return type == BuiltinOptions_TransposeOptions
             ? reinterpret_cast<onert_tflite::TransposeOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::TransposeOptionsT *AsTransposeOptions() const
  {
    return type == BuiltinOptions_TransposeOptions
             ? reinterpret_cast<const onert_tflite::TransposeOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ReducerOptionsT *AsReducerOptions()
  {
    return type == BuiltinOptions_ReducerOptions
             ? reinterpret_cast<onert_tflite::ReducerOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ReducerOptionsT *AsReducerOptions() const
  {
    return type == BuiltinOptions_ReducerOptions
             ? reinterpret_cast<const onert_tflite::ReducerOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SubOptionsT *AsSubOptions()
  {
    return type == BuiltinOptions_SubOptions ? reinterpret_cast<onert_tflite::SubOptionsT *>(value)
                                             : nullptr;
  }
  const onert_tflite::SubOptionsT *AsSubOptions() const
  {
    return type == BuiltinOptions_SubOptions
             ? reinterpret_cast<const onert_tflite::SubOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::DivOptionsT *AsDivOptions()
  {
    return type == BuiltinOptions_DivOptions ? reinterpret_cast<onert_tflite::DivOptionsT *>(value)
                                             : nullptr;
  }
  const onert_tflite::DivOptionsT *AsDivOptions() const
  {
    return type == BuiltinOptions_DivOptions
             ? reinterpret_cast<const onert_tflite::DivOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SqueezeOptionsT *AsSqueezeOptions()
  {
    return type == BuiltinOptions_SqueezeOptions
             ? reinterpret_cast<onert_tflite::SqueezeOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SqueezeOptionsT *AsSqueezeOptions() const
  {
    return type == BuiltinOptions_SqueezeOptions
             ? reinterpret_cast<const onert_tflite::SqueezeOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SequenceRNNOptionsT *AsSequenceRNNOptions()
  {
    return type == BuiltinOptions_SequenceRNNOptions
             ? reinterpret_cast<onert_tflite::SequenceRNNOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SequenceRNNOptionsT *AsSequenceRNNOptions() const
  {
    return type == BuiltinOptions_SequenceRNNOptions
             ? reinterpret_cast<const onert_tflite::SequenceRNNOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::StridedSliceOptionsT *AsStridedSliceOptions()
  {
    return type == BuiltinOptions_StridedSliceOptions
             ? reinterpret_cast<onert_tflite::StridedSliceOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::StridedSliceOptionsT *AsStridedSliceOptions() const
  {
    return type == BuiltinOptions_StridedSliceOptions
             ? reinterpret_cast<const onert_tflite::StridedSliceOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ExpOptionsT *AsExpOptions()
  {
    return type == BuiltinOptions_ExpOptions ? reinterpret_cast<onert_tflite::ExpOptionsT *>(value)
                                             : nullptr;
  }
  const onert_tflite::ExpOptionsT *AsExpOptions() const
  {
    return type == BuiltinOptions_ExpOptions
             ? reinterpret_cast<const onert_tflite::ExpOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::TopKV2OptionsT *AsTopKV2Options()
  {
    return type == BuiltinOptions_TopKV2Options
             ? reinterpret_cast<onert_tflite::TopKV2OptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::TopKV2OptionsT *AsTopKV2Options() const
  {
    return type == BuiltinOptions_TopKV2Options
             ? reinterpret_cast<const onert_tflite::TopKV2OptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SplitOptionsT *AsSplitOptions()
  {
    return type == BuiltinOptions_SplitOptions
             ? reinterpret_cast<onert_tflite::SplitOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SplitOptionsT *AsSplitOptions() const
  {
    return type == BuiltinOptions_SplitOptions
             ? reinterpret_cast<const onert_tflite::SplitOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::LogSoftmaxOptionsT *AsLogSoftmaxOptions()
  {
    return type == BuiltinOptions_LogSoftmaxOptions
             ? reinterpret_cast<onert_tflite::LogSoftmaxOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::LogSoftmaxOptionsT *AsLogSoftmaxOptions() const
  {
    return type == BuiltinOptions_LogSoftmaxOptions
             ? reinterpret_cast<const onert_tflite::LogSoftmaxOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::CastOptionsT *AsCastOptions()
  {
    return type == BuiltinOptions_CastOptions
             ? reinterpret_cast<onert_tflite::CastOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::CastOptionsT *AsCastOptions() const
  {
    return type == BuiltinOptions_CastOptions
             ? reinterpret_cast<const onert_tflite::CastOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::DequantizeOptionsT *AsDequantizeOptions()
  {
    return type == BuiltinOptions_DequantizeOptions
             ? reinterpret_cast<onert_tflite::DequantizeOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::DequantizeOptionsT *AsDequantizeOptions() const
  {
    return type == BuiltinOptions_DequantizeOptions
             ? reinterpret_cast<const onert_tflite::DequantizeOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::MaximumMinimumOptionsT *AsMaximumMinimumOptions()
  {
    return type == BuiltinOptions_MaximumMinimumOptions
             ? reinterpret_cast<onert_tflite::MaximumMinimumOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::MaximumMinimumOptionsT *AsMaximumMinimumOptions() const
  {
    return type == BuiltinOptions_MaximumMinimumOptions
             ? reinterpret_cast<const onert_tflite::MaximumMinimumOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ArgMaxOptionsT *AsArgMaxOptions()
  {
    return type == BuiltinOptions_ArgMaxOptions
             ? reinterpret_cast<onert_tflite::ArgMaxOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ArgMaxOptionsT *AsArgMaxOptions() const
  {
    return type == BuiltinOptions_ArgMaxOptions
             ? reinterpret_cast<const onert_tflite::ArgMaxOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::LessOptionsT *AsLessOptions()
  {
    return type == BuiltinOptions_LessOptions
             ? reinterpret_cast<onert_tflite::LessOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::LessOptionsT *AsLessOptions() const
  {
    return type == BuiltinOptions_LessOptions
             ? reinterpret_cast<const onert_tflite::LessOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::NegOptionsT *AsNegOptions()
  {
    return type == BuiltinOptions_NegOptions ? reinterpret_cast<onert_tflite::NegOptionsT *>(value)
                                             : nullptr;
  }
  const onert_tflite::NegOptionsT *AsNegOptions() const
  {
    return type == BuiltinOptions_NegOptions
             ? reinterpret_cast<const onert_tflite::NegOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::PadV2OptionsT *AsPadV2Options()
  {
    return type == BuiltinOptions_PadV2Options
             ? reinterpret_cast<onert_tflite::PadV2OptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::PadV2OptionsT *AsPadV2Options() const
  {
    return type == BuiltinOptions_PadV2Options
             ? reinterpret_cast<const onert_tflite::PadV2OptionsT *>(value)
             : nullptr;
  }
  onert_tflite::GreaterOptionsT *AsGreaterOptions()
  {
    return type == BuiltinOptions_GreaterOptions
             ? reinterpret_cast<onert_tflite::GreaterOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::GreaterOptionsT *AsGreaterOptions() const
  {
    return type == BuiltinOptions_GreaterOptions
             ? reinterpret_cast<const onert_tflite::GreaterOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::GreaterEqualOptionsT *AsGreaterEqualOptions()
  {
    return type == BuiltinOptions_GreaterEqualOptions
             ? reinterpret_cast<onert_tflite::GreaterEqualOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::GreaterEqualOptionsT *AsGreaterEqualOptions() const
  {
    return type == BuiltinOptions_GreaterEqualOptions
             ? reinterpret_cast<const onert_tflite::GreaterEqualOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::LessEqualOptionsT *AsLessEqualOptions()
  {
    return type == BuiltinOptions_LessEqualOptions
             ? reinterpret_cast<onert_tflite::LessEqualOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::LessEqualOptionsT *AsLessEqualOptions() const
  {
    return type == BuiltinOptions_LessEqualOptions
             ? reinterpret_cast<const onert_tflite::LessEqualOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SelectOptionsT *AsSelectOptions()
  {
    return type == BuiltinOptions_SelectOptions
             ? reinterpret_cast<onert_tflite::SelectOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SelectOptionsT *AsSelectOptions() const
  {
    return type == BuiltinOptions_SelectOptions
             ? reinterpret_cast<const onert_tflite::SelectOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SliceOptionsT *AsSliceOptions()
  {
    return type == BuiltinOptions_SliceOptions
             ? reinterpret_cast<onert_tflite::SliceOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SliceOptionsT *AsSliceOptions() const
  {
    return type == BuiltinOptions_SliceOptions
             ? reinterpret_cast<const onert_tflite::SliceOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::TransposeConvOptionsT *AsTransposeConvOptions()
  {
    return type == BuiltinOptions_TransposeConvOptions
             ? reinterpret_cast<onert_tflite::TransposeConvOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::TransposeConvOptionsT *AsTransposeConvOptions() const
  {
    return type == BuiltinOptions_TransposeConvOptions
             ? reinterpret_cast<const onert_tflite::TransposeConvOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SparseToDenseOptionsT *AsSparseToDenseOptions()
  {
    return type == BuiltinOptions_SparseToDenseOptions
             ? reinterpret_cast<onert_tflite::SparseToDenseOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SparseToDenseOptionsT *AsSparseToDenseOptions() const
  {
    return type == BuiltinOptions_SparseToDenseOptions
             ? reinterpret_cast<const onert_tflite::SparseToDenseOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::TileOptionsT *AsTileOptions()
  {
    return type == BuiltinOptions_TileOptions
             ? reinterpret_cast<onert_tflite::TileOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::TileOptionsT *AsTileOptions() const
  {
    return type == BuiltinOptions_TileOptions
             ? reinterpret_cast<const onert_tflite::TileOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ExpandDimsOptionsT *AsExpandDimsOptions()
  {
    return type == BuiltinOptions_ExpandDimsOptions
             ? reinterpret_cast<onert_tflite::ExpandDimsOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ExpandDimsOptionsT *AsExpandDimsOptions() const
  {
    return type == BuiltinOptions_ExpandDimsOptions
             ? reinterpret_cast<const onert_tflite::ExpandDimsOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::EqualOptionsT *AsEqualOptions()
  {
    return type == BuiltinOptions_EqualOptions
             ? reinterpret_cast<onert_tflite::EqualOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::EqualOptionsT *AsEqualOptions() const
  {
    return type == BuiltinOptions_EqualOptions
             ? reinterpret_cast<const onert_tflite::EqualOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::NotEqualOptionsT *AsNotEqualOptions()
  {
    return type == BuiltinOptions_NotEqualOptions
             ? reinterpret_cast<onert_tflite::NotEqualOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::NotEqualOptionsT *AsNotEqualOptions() const
  {
    return type == BuiltinOptions_NotEqualOptions
             ? reinterpret_cast<const onert_tflite::NotEqualOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ShapeOptionsT *AsShapeOptions()
  {
    return type == BuiltinOptions_ShapeOptions
             ? reinterpret_cast<onert_tflite::ShapeOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ShapeOptionsT *AsShapeOptions() const
  {
    return type == BuiltinOptions_ShapeOptions
             ? reinterpret_cast<const onert_tflite::ShapeOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::PowOptionsT *AsPowOptions()
  {
    return type == BuiltinOptions_PowOptions ? reinterpret_cast<onert_tflite::PowOptionsT *>(value)
                                             : nullptr;
  }
  const onert_tflite::PowOptionsT *AsPowOptions() const
  {
    return type == BuiltinOptions_PowOptions
             ? reinterpret_cast<const onert_tflite::PowOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ArgMinOptionsT *AsArgMinOptions()
  {
    return type == BuiltinOptions_ArgMinOptions
             ? reinterpret_cast<onert_tflite::ArgMinOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ArgMinOptionsT *AsArgMinOptions() const
  {
    return type == BuiltinOptions_ArgMinOptions
             ? reinterpret_cast<const onert_tflite::ArgMinOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::FakeQuantOptionsT *AsFakeQuantOptions()
  {
    return type == BuiltinOptions_FakeQuantOptions
             ? reinterpret_cast<onert_tflite::FakeQuantOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::FakeQuantOptionsT *AsFakeQuantOptions() const
  {
    return type == BuiltinOptions_FakeQuantOptions
             ? reinterpret_cast<const onert_tflite::FakeQuantOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::PackOptionsT *AsPackOptions()
  {
    return type == BuiltinOptions_PackOptions
             ? reinterpret_cast<onert_tflite::PackOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::PackOptionsT *AsPackOptions() const
  {
    return type == BuiltinOptions_PackOptions
             ? reinterpret_cast<const onert_tflite::PackOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::LogicalOrOptionsT *AsLogicalOrOptions()
  {
    return type == BuiltinOptions_LogicalOrOptions
             ? reinterpret_cast<onert_tflite::LogicalOrOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::LogicalOrOptionsT *AsLogicalOrOptions() const
  {
    return type == BuiltinOptions_LogicalOrOptions
             ? reinterpret_cast<const onert_tflite::LogicalOrOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::OneHotOptionsT *AsOneHotOptions()
  {
    return type == BuiltinOptions_OneHotOptions
             ? reinterpret_cast<onert_tflite::OneHotOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::OneHotOptionsT *AsOneHotOptions() const
  {
    return type == BuiltinOptions_OneHotOptions
             ? reinterpret_cast<const onert_tflite::OneHotOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::LogicalAndOptionsT *AsLogicalAndOptions()
  {
    return type == BuiltinOptions_LogicalAndOptions
             ? reinterpret_cast<onert_tflite::LogicalAndOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::LogicalAndOptionsT *AsLogicalAndOptions() const
  {
    return type == BuiltinOptions_LogicalAndOptions
             ? reinterpret_cast<const onert_tflite::LogicalAndOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::LogicalNotOptionsT *AsLogicalNotOptions()
  {
    return type == BuiltinOptions_LogicalNotOptions
             ? reinterpret_cast<onert_tflite::LogicalNotOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::LogicalNotOptionsT *AsLogicalNotOptions() const
  {
    return type == BuiltinOptions_LogicalNotOptions
             ? reinterpret_cast<const onert_tflite::LogicalNotOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::UnpackOptionsT *AsUnpackOptions()
  {
    return type == BuiltinOptions_UnpackOptions
             ? reinterpret_cast<onert_tflite::UnpackOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::UnpackOptionsT *AsUnpackOptions() const
  {
    return type == BuiltinOptions_UnpackOptions
             ? reinterpret_cast<const onert_tflite::UnpackOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::FloorDivOptionsT *AsFloorDivOptions()
  {
    return type == BuiltinOptions_FloorDivOptions
             ? reinterpret_cast<onert_tflite::FloorDivOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::FloorDivOptionsT *AsFloorDivOptions() const
  {
    return type == BuiltinOptions_FloorDivOptions
             ? reinterpret_cast<const onert_tflite::FloorDivOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SquareOptionsT *AsSquareOptions()
  {
    return type == BuiltinOptions_SquareOptions
             ? reinterpret_cast<onert_tflite::SquareOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SquareOptionsT *AsSquareOptions() const
  {
    return type == BuiltinOptions_SquareOptions
             ? reinterpret_cast<const onert_tflite::SquareOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ZerosLikeOptionsT *AsZerosLikeOptions()
  {
    return type == BuiltinOptions_ZerosLikeOptions
             ? reinterpret_cast<onert_tflite::ZerosLikeOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ZerosLikeOptionsT *AsZerosLikeOptions() const
  {
    return type == BuiltinOptions_ZerosLikeOptions
             ? reinterpret_cast<const onert_tflite::ZerosLikeOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::FillOptionsT *AsFillOptions()
  {
    return type == BuiltinOptions_FillOptions
             ? reinterpret_cast<onert_tflite::FillOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::FillOptionsT *AsFillOptions() const
  {
    return type == BuiltinOptions_FillOptions
             ? reinterpret_cast<const onert_tflite::FillOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::BidirectionalSequenceLSTMOptionsT *AsBidirectionalSequenceLSTMOptions()
  {
    return type == BuiltinOptions_BidirectionalSequenceLSTMOptions
             ? reinterpret_cast<onert_tflite::BidirectionalSequenceLSTMOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::BidirectionalSequenceLSTMOptionsT *AsBidirectionalSequenceLSTMOptions() const
  {
    return type == BuiltinOptions_BidirectionalSequenceLSTMOptions
             ? reinterpret_cast<const onert_tflite::BidirectionalSequenceLSTMOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::BidirectionalSequenceRNNOptionsT *AsBidirectionalSequenceRNNOptions()
  {
    return type == BuiltinOptions_BidirectionalSequenceRNNOptions
             ? reinterpret_cast<onert_tflite::BidirectionalSequenceRNNOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::BidirectionalSequenceRNNOptionsT *AsBidirectionalSequenceRNNOptions() const
  {
    return type == BuiltinOptions_BidirectionalSequenceRNNOptions
             ? reinterpret_cast<const onert_tflite::BidirectionalSequenceRNNOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::UnidirectionalSequenceLSTMOptionsT *AsUnidirectionalSequenceLSTMOptions()
  {
    return type == BuiltinOptions_UnidirectionalSequenceLSTMOptions
             ? reinterpret_cast<onert_tflite::UnidirectionalSequenceLSTMOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::UnidirectionalSequenceLSTMOptionsT *
  AsUnidirectionalSequenceLSTMOptions() const
  {
    return type == BuiltinOptions_UnidirectionalSequenceLSTMOptions
             ? reinterpret_cast<const onert_tflite::UnidirectionalSequenceLSTMOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::FloorModOptionsT *AsFloorModOptions()
  {
    return type == BuiltinOptions_FloorModOptions
             ? reinterpret_cast<onert_tflite::FloorModOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::FloorModOptionsT *AsFloorModOptions() const
  {
    return type == BuiltinOptions_FloorModOptions
             ? reinterpret_cast<const onert_tflite::FloorModOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::RangeOptionsT *AsRangeOptions()
  {
    return type == BuiltinOptions_RangeOptions
             ? reinterpret_cast<onert_tflite::RangeOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::RangeOptionsT *AsRangeOptions() const
  {
    return type == BuiltinOptions_RangeOptions
             ? reinterpret_cast<const onert_tflite::RangeOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ResizeNearestNeighborOptionsT *AsResizeNearestNeighborOptions()
  {
    return type == BuiltinOptions_ResizeNearestNeighborOptions
             ? reinterpret_cast<onert_tflite::ResizeNearestNeighborOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ResizeNearestNeighborOptionsT *AsResizeNearestNeighborOptions() const
  {
    return type == BuiltinOptions_ResizeNearestNeighborOptions
             ? reinterpret_cast<const onert_tflite::ResizeNearestNeighborOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::LeakyReluOptionsT *AsLeakyReluOptions()
  {
    return type == BuiltinOptions_LeakyReluOptions
             ? reinterpret_cast<onert_tflite::LeakyReluOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::LeakyReluOptionsT *AsLeakyReluOptions() const
  {
    return type == BuiltinOptions_LeakyReluOptions
             ? reinterpret_cast<const onert_tflite::LeakyReluOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SquaredDifferenceOptionsT *AsSquaredDifferenceOptions()
  {
    return type == BuiltinOptions_SquaredDifferenceOptions
             ? reinterpret_cast<onert_tflite::SquaredDifferenceOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SquaredDifferenceOptionsT *AsSquaredDifferenceOptions() const
  {
    return type == BuiltinOptions_SquaredDifferenceOptions
             ? reinterpret_cast<const onert_tflite::SquaredDifferenceOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::MirrorPadOptionsT *AsMirrorPadOptions()
  {
    return type == BuiltinOptions_MirrorPadOptions
             ? reinterpret_cast<onert_tflite::MirrorPadOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::MirrorPadOptionsT *AsMirrorPadOptions() const
  {
    return type == BuiltinOptions_MirrorPadOptions
             ? reinterpret_cast<const onert_tflite::MirrorPadOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::AbsOptionsT *AsAbsOptions()
  {
    return type == BuiltinOptions_AbsOptions ? reinterpret_cast<onert_tflite::AbsOptionsT *>(value)
                                             : nullptr;
  }
  const onert_tflite::AbsOptionsT *AsAbsOptions() const
  {
    return type == BuiltinOptions_AbsOptions
             ? reinterpret_cast<const onert_tflite::AbsOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SplitVOptionsT *AsSplitVOptions()
  {
    return type == BuiltinOptions_SplitVOptions
             ? reinterpret_cast<onert_tflite::SplitVOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SplitVOptionsT *AsSplitVOptions() const
  {
    return type == BuiltinOptions_SplitVOptions
             ? reinterpret_cast<const onert_tflite::SplitVOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::UniqueOptionsT *AsUniqueOptions()
  {
    return type == BuiltinOptions_UniqueOptions
             ? reinterpret_cast<onert_tflite::UniqueOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::UniqueOptionsT *AsUniqueOptions() const
  {
    return type == BuiltinOptions_UniqueOptions
             ? reinterpret_cast<const onert_tflite::UniqueOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ReverseV2OptionsT *AsReverseV2Options()
  {
    return type == BuiltinOptions_ReverseV2Options
             ? reinterpret_cast<onert_tflite::ReverseV2OptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ReverseV2OptionsT *AsReverseV2Options() const
  {
    return type == BuiltinOptions_ReverseV2Options
             ? reinterpret_cast<const onert_tflite::ReverseV2OptionsT *>(value)
             : nullptr;
  }
  onert_tflite::AddNOptionsT *AsAddNOptions()
  {
    return type == BuiltinOptions_AddNOptions
             ? reinterpret_cast<onert_tflite::AddNOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::AddNOptionsT *AsAddNOptions() const
  {
    return type == BuiltinOptions_AddNOptions
             ? reinterpret_cast<const onert_tflite::AddNOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::GatherNdOptionsT *AsGatherNdOptions()
  {
    return type == BuiltinOptions_GatherNdOptions
             ? reinterpret_cast<onert_tflite::GatherNdOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::GatherNdOptionsT *AsGatherNdOptions() const
  {
    return type == BuiltinOptions_GatherNdOptions
             ? reinterpret_cast<const onert_tflite::GatherNdOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::CosOptionsT *AsCosOptions()
  {
    return type == BuiltinOptions_CosOptions ? reinterpret_cast<onert_tflite::CosOptionsT *>(value)
                                             : nullptr;
  }
  const onert_tflite::CosOptionsT *AsCosOptions() const
  {
    return type == BuiltinOptions_CosOptions
             ? reinterpret_cast<const onert_tflite::CosOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::WhereOptionsT *AsWhereOptions()
  {
    return type == BuiltinOptions_WhereOptions
             ? reinterpret_cast<onert_tflite::WhereOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::WhereOptionsT *AsWhereOptions() const
  {
    return type == BuiltinOptions_WhereOptions
             ? reinterpret_cast<const onert_tflite::WhereOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::RankOptionsT *AsRankOptions()
  {
    return type == BuiltinOptions_RankOptions
             ? reinterpret_cast<onert_tflite::RankOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::RankOptionsT *AsRankOptions() const
  {
    return type == BuiltinOptions_RankOptions
             ? reinterpret_cast<const onert_tflite::RankOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ReverseSequenceOptionsT *AsReverseSequenceOptions()
  {
    return type == BuiltinOptions_ReverseSequenceOptions
             ? reinterpret_cast<onert_tflite::ReverseSequenceOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ReverseSequenceOptionsT *AsReverseSequenceOptions() const
  {
    return type == BuiltinOptions_ReverseSequenceOptions
             ? reinterpret_cast<const onert_tflite::ReverseSequenceOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::MatrixDiagOptionsT *AsMatrixDiagOptions()
  {
    return type == BuiltinOptions_MatrixDiagOptions
             ? reinterpret_cast<onert_tflite::MatrixDiagOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::MatrixDiagOptionsT *AsMatrixDiagOptions() const
  {
    return type == BuiltinOptions_MatrixDiagOptions
             ? reinterpret_cast<const onert_tflite::MatrixDiagOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::QuantizeOptionsT *AsQuantizeOptions()
  {
    return type == BuiltinOptions_QuantizeOptions
             ? reinterpret_cast<onert_tflite::QuantizeOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::QuantizeOptionsT *AsQuantizeOptions() const
  {
    return type == BuiltinOptions_QuantizeOptions
             ? reinterpret_cast<const onert_tflite::QuantizeOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::MatrixSetDiagOptionsT *AsMatrixSetDiagOptions()
  {
    return type == BuiltinOptions_MatrixSetDiagOptions
             ? reinterpret_cast<onert_tflite::MatrixSetDiagOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::MatrixSetDiagOptionsT *AsMatrixSetDiagOptions() const
  {
    return type == BuiltinOptions_MatrixSetDiagOptions
             ? reinterpret_cast<const onert_tflite::MatrixSetDiagOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::HardSwishOptionsT *AsHardSwishOptions()
  {
    return type == BuiltinOptions_HardSwishOptions
             ? reinterpret_cast<onert_tflite::HardSwishOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::HardSwishOptionsT *AsHardSwishOptions() const
  {
    return type == BuiltinOptions_HardSwishOptions
             ? reinterpret_cast<const onert_tflite::HardSwishOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::IfOptionsT *AsIfOptions()
  {
    return type == BuiltinOptions_IfOptions ? reinterpret_cast<onert_tflite::IfOptionsT *>(value)
                                            : nullptr;
  }
  const onert_tflite::IfOptionsT *AsIfOptions() const
  {
    return type == BuiltinOptions_IfOptions
             ? reinterpret_cast<const onert_tflite::IfOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::WhileOptionsT *AsWhileOptions()
  {
    return type == BuiltinOptions_WhileOptions
             ? reinterpret_cast<onert_tflite::WhileOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::WhileOptionsT *AsWhileOptions() const
  {
    return type == BuiltinOptions_WhileOptions
             ? reinterpret_cast<const onert_tflite::WhileOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::DepthToSpaceOptionsT *AsDepthToSpaceOptions()
  {
    return type == BuiltinOptions_DepthToSpaceOptions
             ? reinterpret_cast<onert_tflite::DepthToSpaceOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::DepthToSpaceOptionsT *AsDepthToSpaceOptions() const
  {
    return type == BuiltinOptions_DepthToSpaceOptions
             ? reinterpret_cast<const onert_tflite::DepthToSpaceOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::NonMaxSuppressionV4OptionsT *AsNonMaxSuppressionV4Options()
  {
    return type == BuiltinOptions_NonMaxSuppressionV4Options
             ? reinterpret_cast<onert_tflite::NonMaxSuppressionV4OptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::NonMaxSuppressionV4OptionsT *AsNonMaxSuppressionV4Options() const
  {
    return type == BuiltinOptions_NonMaxSuppressionV4Options
             ? reinterpret_cast<const onert_tflite::NonMaxSuppressionV4OptionsT *>(value)
             : nullptr;
  }
  onert_tflite::NonMaxSuppressionV5OptionsT *AsNonMaxSuppressionV5Options()
  {
    return type == BuiltinOptions_NonMaxSuppressionV5Options
             ? reinterpret_cast<onert_tflite::NonMaxSuppressionV5OptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::NonMaxSuppressionV5OptionsT *AsNonMaxSuppressionV5Options() const
  {
    return type == BuiltinOptions_NonMaxSuppressionV5Options
             ? reinterpret_cast<const onert_tflite::NonMaxSuppressionV5OptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ScatterNdOptionsT *AsScatterNdOptions()
  {
    return type == BuiltinOptions_ScatterNdOptions
             ? reinterpret_cast<onert_tflite::ScatterNdOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ScatterNdOptionsT *AsScatterNdOptions() const
  {
    return type == BuiltinOptions_ScatterNdOptions
             ? reinterpret_cast<const onert_tflite::ScatterNdOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SelectV2OptionsT *AsSelectV2Options()
  {
    return type == BuiltinOptions_SelectV2Options
             ? reinterpret_cast<onert_tflite::SelectV2OptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SelectV2OptionsT *AsSelectV2Options() const
  {
    return type == BuiltinOptions_SelectV2Options
             ? reinterpret_cast<const onert_tflite::SelectV2OptionsT *>(value)
             : nullptr;
  }
  onert_tflite::DensifyOptionsT *AsDensifyOptions()
  {
    return type == BuiltinOptions_DensifyOptions
             ? reinterpret_cast<onert_tflite::DensifyOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::DensifyOptionsT *AsDensifyOptions() const
  {
    return type == BuiltinOptions_DensifyOptions
             ? reinterpret_cast<const onert_tflite::DensifyOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::SegmentSumOptionsT *AsSegmentSumOptions()
  {
    return type == BuiltinOptions_SegmentSumOptions
             ? reinterpret_cast<onert_tflite::SegmentSumOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::SegmentSumOptionsT *AsSegmentSumOptions() const
  {
    return type == BuiltinOptions_SegmentSumOptions
             ? reinterpret_cast<const onert_tflite::SegmentSumOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::BatchMatMulOptionsT *AsBatchMatMulOptions()
  {
    return type == BuiltinOptions_BatchMatMulOptions
             ? reinterpret_cast<onert_tflite::BatchMatMulOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::BatchMatMulOptionsT *AsBatchMatMulOptions() const
  {
    return type == BuiltinOptions_BatchMatMulOptions
             ? reinterpret_cast<const onert_tflite::BatchMatMulOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::CumsumOptionsT *AsCumsumOptions()
  {
    return type == BuiltinOptions_CumsumOptions
             ? reinterpret_cast<onert_tflite::CumsumOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::CumsumOptionsT *AsCumsumOptions() const
  {
    return type == BuiltinOptions_CumsumOptions
             ? reinterpret_cast<const onert_tflite::CumsumOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::CallOnceOptionsT *AsCallOnceOptions()
  {
    return type == BuiltinOptions_CallOnceOptions
             ? reinterpret_cast<onert_tflite::CallOnceOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::CallOnceOptionsT *AsCallOnceOptions() const
  {
    return type == BuiltinOptions_CallOnceOptions
             ? reinterpret_cast<const onert_tflite::CallOnceOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::BroadcastToOptionsT *AsBroadcastToOptions()
  {
    return type == BuiltinOptions_BroadcastToOptions
             ? reinterpret_cast<onert_tflite::BroadcastToOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::BroadcastToOptionsT *AsBroadcastToOptions() const
  {
    return type == BuiltinOptions_BroadcastToOptions
             ? reinterpret_cast<const onert_tflite::BroadcastToOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::Rfft2dOptionsT *AsRfft2dOptions()
  {
    return type == BuiltinOptions_Rfft2dOptions
             ? reinterpret_cast<onert_tflite::Rfft2dOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::Rfft2dOptionsT *AsRfft2dOptions() const
  {
    return type == BuiltinOptions_Rfft2dOptions
             ? reinterpret_cast<const onert_tflite::Rfft2dOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::Conv3DOptionsT *AsConv3DOptions()
  {
    return type == BuiltinOptions_Conv3DOptions
             ? reinterpret_cast<onert_tflite::Conv3DOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::Conv3DOptionsT *AsConv3DOptions() const
  {
    return type == BuiltinOptions_Conv3DOptions
             ? reinterpret_cast<const onert_tflite::Conv3DOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::HashtableOptionsT *AsHashtableOptions()
  {
    return type == BuiltinOptions_HashtableOptions
             ? reinterpret_cast<onert_tflite::HashtableOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::HashtableOptionsT *AsHashtableOptions() const
  {
    return type == BuiltinOptions_HashtableOptions
             ? reinterpret_cast<const onert_tflite::HashtableOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::HashtableFindOptionsT *AsHashtableFindOptions()
  {
    return type == BuiltinOptions_HashtableFindOptions
             ? reinterpret_cast<onert_tflite::HashtableFindOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::HashtableFindOptionsT *AsHashtableFindOptions() const
  {
    return type == BuiltinOptions_HashtableFindOptions
             ? reinterpret_cast<const onert_tflite::HashtableFindOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::HashtableImportOptionsT *AsHashtableImportOptions()
  {
    return type == BuiltinOptions_HashtableImportOptions
             ? reinterpret_cast<onert_tflite::HashtableImportOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::HashtableImportOptionsT *AsHashtableImportOptions() const
  {
    return type == BuiltinOptions_HashtableImportOptions
             ? reinterpret_cast<const onert_tflite::HashtableImportOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::HashtableSizeOptionsT *AsHashtableSizeOptions()
  {
    return type == BuiltinOptions_HashtableSizeOptions
             ? reinterpret_cast<onert_tflite::HashtableSizeOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::HashtableSizeOptionsT *AsHashtableSizeOptions() const
  {
    return type == BuiltinOptions_HashtableSizeOptions
             ? reinterpret_cast<const onert_tflite::HashtableSizeOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::VarHandleOptionsT *AsVarHandleOptions()
  {
    return type == BuiltinOptions_VarHandleOptions
             ? reinterpret_cast<onert_tflite::VarHandleOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::VarHandleOptionsT *AsVarHandleOptions() const
  {
    return type == BuiltinOptions_VarHandleOptions
             ? reinterpret_cast<const onert_tflite::VarHandleOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::ReadVariableOptionsT *AsReadVariableOptions()
  {
    return type == BuiltinOptions_ReadVariableOptions
             ? reinterpret_cast<onert_tflite::ReadVariableOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::ReadVariableOptionsT *AsReadVariableOptions() const
  {
    return type == BuiltinOptions_ReadVariableOptions
             ? reinterpret_cast<const onert_tflite::ReadVariableOptionsT *>(value)
             : nullptr;
  }
  onert_tflite::AssignVariableOptionsT *AsAssignVariableOptions()
  {
    return type == BuiltinOptions_AssignVariableOptions
             ? reinterpret_cast<onert_tflite::AssignVariableOptionsT *>(value)
             : nullptr;
  }
  const onert_tflite::AssignVariableOptionsT *AsAssignVariableOptions() const
  {
    return type == BuiltinOptions_AssignVariableOptions
             ? reinterpret_cast<const onert_tflite::AssignVariableOptionsT *>(value)
             : nullptr;
  }
};
...
struct QuantizationParametersT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::QuantizationDetailsUnion details;
...
struct DimensionMetadataT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::DimensionType format;
  int32_t dense_size;
  onert_tflite::SparseIndexVectorUnion array_segments;
  onert_tflite::SparseIndexVectorUnion array_indices;
  DimensionMetadataT() : format(onert_tflite::DimensionType_DENSE), dense_size(0) {}
};
...
struct SparsityParametersT : public flatbuffers::NativeTable
{
  ...
  std::vector<std::unique_ptr<onert_tflite::DimensionMetadataT>> dim_metadata;
  SparsityParametersT() {}
};
...
struct TensorT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::TensorType type;
  uint32_t buffer;
  std::string name;
  std::unique_ptr<onert_tflite::QuantizationParametersT> quantization;
  bool is_variable;
  std::unique_ptr<onert_tflite::SparsityParametersT> sparsity;
  std::vector<int32_t> shape_signature;
  TensorT() : type(onert_tflite::TensorType_FLOAT32), buffer(0), is_variable(false) {}
};
...
struct Conv2DOptionsT : public flatbuffers::NativeTable
{
  ...
  Conv2DOptionsT()
    : padding(onert_tflite::Padding_SAME), stride_w(0), stride_h(0),
      fused_activation_function(onert_tflite::ActivationFunctionType_NONE), dilation_w_factor(1),
      dilation_h_factor(1)
  {
  }
};
...
struct Conv3DOptionsT : public flatbuffers::NativeTable
{
  ...
  int32_t dilation_h_factor;
  Conv3DOptionsT()
    : padding(onert_tflite::Padding_SAME), stride_d(0), stride_w(0), stride_h(0),
      fused_activation_function(onert_tflite::ActivationFunctionType_NONE), dilation_d_factor(1),
...
struct Pool2DOptionsT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::ActivationFunctionType fused_activation_function;
  Pool2DOptionsT()
    : padding(onert_tflite::Padding_SAME), stride_w(0), stride_h(0), filter_width(0),
      filter_height(0), fused_activation_function(onert_tflite::ActivationFunctionType_NONE)
  {
  }
};
...
struct DepthwiseConv2DOptionsT : public flatbuffers::NativeTable
{
  ...
  DepthwiseConv2DOptionsT()
    : padding(onert_tflite::Padding_SAME), stride_w(0), stride_h(0), depth_multiplier(0),
      fused_activation_function(onert_tflite::ActivationFunctionType_NONE), dilation_w_factor(1),
      dilation_h_factor(1)
  {
  }
...
struct LSHProjectionOptionsT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::LSHProjectionType type;
  LSHProjectionOptionsT() : type(onert_tflite::LSHProjectionType_UNKNOWN) {}
};
...
struct SVDFOptionsT : public flatbuffers::NativeTable
{
  ...
  SVDFOptionsT()
    : rank(0), fused_activation_function(onert_tflite::ActivationFunctionType_NONE),
...
struct RNNOptionsT : public flatbuffers::NativeTable
{
  ...
  bool asymmetric_quantize_inputs;
  RNNOptionsT()
    : fused_activation_function(onert_tflite::ActivationFunctionType_NONE),
      asymmetric_quantize_inputs(false)
  {
  }
};
...
struct SequenceRNNOptionsT : public flatbuffers::NativeTable
{
  ...
  bool asymmetric_quantize_inputs;
  SequenceRNNOptionsT()
    : time_major(false), fused_activation_function(onert_tflite::ActivationFunctionType_NONE),
      asymmetric_quantize_inputs(false)
  {
  }
};
...
struct FullyConnectedOptionsT : public flatbuffers::NativeTable
{
  ...
  FullyConnectedOptionsT()
    : fused_activation_function(onert_tflite::ActivationFunctionType_NONE),
      weights_format(onert_tflite::FullyConnectedOptionsWeightsFormat_DEFAULT),
...
struct ConcatenationOptionsT : public flatbuffers::NativeTable
{
  ...
  ConcatenationOptionsT()
    : axis(0), fused_activation_function(onert_tflite::ActivationFunctionType_NONE)
  {
  }
};
...
struct AddOptionsT : public flatbuffers::NativeTable
{
  ...
  AddOptionsT()
    : fused_activation_function(onert_tflite::ActivationFunctionType_NONE), pot_scale_int16(true)
  {
  }
};
...
struct MulOptionsT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::ActivationFunctionType fused_activation_function;
  MulOptionsT() : fused_activation_function(onert_tflite::ActivationFunctionType_NONE) {}
};
...
struct L2NormOptionsT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::ActivationFunctionType fused_activation_function;
  L2NormOptionsT() : fused_activation_function(onert_tflite::ActivationFunctionType_NONE) {}
};
...
struct LSTMOptionsT : public flatbuffers::NativeTable
{
  ...
  float cell_clip;
  float proj_clip;
  onert_tflite::LSTMKernelType kernel_type;
  bool asymmetric_quantize_inputs;
  LSTMOptionsT()
    : fused_activation_function(onert_tflite::ActivationFunctionType_NONE), cell_clip(0.0f),
      proj_clip(0.0f), kernel_type(onert_tflite::LSTMKernelType_FULL),
      asymmetric_quantize_inputs(false)
  {
  }
};
...
struct UnidirectionalSequenceLSTMOptionsT : public flatbuffers::NativeTable
{
  ...
  UnidirectionalSequenceLSTMOptionsT()
    : fused_activation_function(onert_tflite::ActivationFunctionType_NONE), cell_clip(0.0f),
      proj_clip(0.0f), time_major(false), asymmetric_quantize_inputs(false)
  {
  }
};
...
struct BidirectionalSequenceLSTMOptionsT : public flatbuffers::NativeTable
{
  ...
  BidirectionalSequenceLSTMOptionsT()
    : fused_activation_function(onert_tflite::ActivationFunctionType_NONE), cell_clip(0.0f),
      proj_clip(0.0f), merge_outputs(false), time_major(true), asymmetric_quantize_inputs(false)
  {
  }
};
...
struct DivOptionsT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::ActivationFunctionType fused_activation_function;
  DivOptionsT() : fused_activation_function(onert_tflite::ActivationFunctionType_NONE) {}
};
...
struct EmbeddingLookupSparseOptionsT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::CombinerType combiner;
  EmbeddingLookupSparseOptionsT() : combiner(onert_tflite::CombinerType_SUM) {}
};
...
struct CastOptionsT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::TensorType in_data_type;
  onert_tflite::TensorType out_data_type;
  CastOptionsT()
    : in_data_type(onert_tflite::TensorType_FLOAT32),
      out_data_type(onert_tflite::TensorType_FLOAT32)
  {
  }
};
...
struct ArgMaxOptionsT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::TensorType output_type;
  ArgMaxOptionsT() : output_type(onert_tflite::TensorType_FLOAT32) {}
};
...
struct ArgMinOptionsT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::TensorType output_type;
  ArgMinOptionsT() : output_type(onert_tflite::TensorType_FLOAT32) {}
};
...
struct TransposeConvOptionsT : public flatbuffers::NativeTable
{
  ...
  int32_t stride_w;
  int32_t stride_h;
  TransposeConvOptionsT() : padding(onert_tflite::Padding_SAME), stride_w(0), stride_h(0) {}
};
...
struct ShapeOptionsT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::TensorType out_type;
  ShapeOptionsT() : out_type(onert_tflite::TensorType_FLOAT32) {}
};
...
struct MirrorPadOptionsT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::MirrorPadMode mode;
  MirrorPadOptionsT() : mode(onert_tflite::MirrorPadMode_REFLECT) {}
};
...
struct UniqueOptionsT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::TensorType idx_out_type;
  UniqueOptionsT() : idx_out_type(onert_tflite::TensorType_INT32) {}
};
...
struct BatchMatMulOptionsT : public flatbuffers::NativeTable
{
  ...
  bool adj_y;
  bool asymmetric_quantize_inputs;
  BatchMatMulOptionsT() : adj_x(false), adj_y(false), asymmetric_quantize_inputs(false) {}
};
...
struct HashtableOptionsT : public flatbuffers::NativeTable
{
  ...
  int32_t table_id;
  onert_tflite::TensorType key_dtype;
  onert_tflite::TensorType value_dtype;
  HashtableOptionsT()
    : table_id(0), key_dtype(onert_tflite::TensorType_FLOAT32),
      value_dtype(onert_tflite::TensorType_FLOAT32)
  {
  }
};
...
struct OperatorCodeT : public flatbuffers::NativeTable
{
  ...
  int32_t version;
  onert_tflite::BuiltinOperator builtin_code;
  OperatorCodeT()
    : deprecated_builtin_code(0), version(1), builtin_code(onert_tflite::BuiltinOperator_ADD)
  {
  }
};
...
struct OperatorT : public flatbuffers::NativeTable
{
  ...
  onert_tflite::BuiltinOptionsUnion builtin_options;
  std::vector<uint8_t> custom_options;
  onert_tflite::CustomOptionsFormat custom_options_format;
  std::vector<bool> mutating_variable_inputs;
  std::vector<int32_t> intermediates;
  OperatorT()
    : opcode_index(0), custom_options_format(onert_tflite::CustomOptionsFormat_FLEXBUFFERS)
  {
  }
};
...
struct SubGraphT : public flatbuffers::NativeTable
{
  ...
  std::vector<std::unique_ptr<onert_tflite::TensorT>> tensors;
  std::vector<int32_t> inputs;
  std::vector<int32_t> outputs;
  std::vector<std::unique_ptr<onert_tflite::OperatorT>> operators;
  std::string name;
  SubGraphT() {}
};
...
struct SignatureDefT : public flatbuffers::NativeTable
{
  ...
  std::vector<std::unique_ptr<onert_tflite::TensorMapT>> inputs;
  std::vector<std::unique_ptr<onert_tflite::TensorMapT>> outputs;
...
struct SignatureDef FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
  ...
  bool Verify(flatbuffers::Verifier &verifier) const
  {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_INPUTS) &&
           ...
           VerifyOffset(verifier, VT_OUTPUTS) && verifier.VerifyVector(outputs()) &&
           verifier.VerifyVectorOfTables(outputs()) && VerifyOffset(verifier, VT_METHOD_NAME) &&
           verifier.VerifyString(method_name()) && VerifyOffset(verifier, VT_KEY) &&
           verifier.VerifyString(key()) && VerifyField<uint32_t>(verifier, VT_SUBGRAPH_INDEX) &&
           verifier.EndTable();
  }
...
inline flatbuffers::Offset<SignatureDef> CreateSignatureDef(
  ...
  flatbuffers::Offset<flatbuffers::String> key = 0, uint32_t subgraph_index = 0)
{
...
inline flatbuffers::Offset<SignatureDef> CreateSignatureDefDirect(
  ...
  const char *method_name = nullptr, const char *key = nullptr, uint32_t subgraph_index = 0)
{
  auto inputs__ =
  ...
  return onert_tflite::CreateSignatureDef(_fbb, inputs__, outputs__, method_name__, key__,
                                          subgraph_index);
}
...
struct ModelT : public flatbuffers::NativeTable
{
  ...
  uint32_t version;
  std::vector<std::unique_ptr<onert_tflite::OperatorCodeT>> operator_codes;
  std::vector<std::unique_ptr<onert_tflite::SubGraphT>> subgraphs;
  std::string description;
  std::vector<std::unique_ptr<onert_tflite::BufferT>> buffers;
  std::vector<int32_t> metadata_buffer;
  std::vector<std::unique_ptr<onert_tflite::MetadataT>> metadata;
  std::vector<std::unique_ptr<onert_tflite::SignatureDefT>> signature_defs;
  ModelT() : version(0) {}
};
                         ...
                         const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateCustomQuantization(_fbb, _custom);
}
                                 ...
                                 const flatbuffers::resolver_function_t *_resolver) const
{
  ...
  }
  {
    ...
    if (_e)
      _o->details.value =
        onert_tflite::QuantizationDetailsUnion::UnPack(_e, details_type(), _resolver);
  }
  {
                             ...
                             const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateQuantizationParameters(_fbb, _min, _max, _scale, _zero_point,
                                                    _details_type, _details, _quantized_dimension);
}
                  ...
                  const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateInt32Vector(_fbb, _values);
}
                   ...
                   const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _values = _o->values.size() ? _fbb.CreateVector(_o->values) : 0;
  return onert_tflite::CreateUint16Vector(_fbb, _values);
}
                  ...
                  const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _values = _o->values.size() ? _fbb.CreateVector(_o->values) : 0;
  return onert_tflite::CreateUint8Vector(_fbb, _values);
}
  ...
  }
  {
    ...
    if (_e)
      _o->array_segments.value =
        onert_tflite::SparseIndexVectorUnion::UnPack(_e, array_segments_type(), _resolver);
  }
  {
  ...
  }
  {
    ...
    if (_e)
      _o->array_indices.value =
        onert_tflite::SparseIndexVectorUnion::UnPack(_e, array_indices_type(), _resolver);
  }
}
                        ...
                        const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateDimensionMetadata(_fbb, _format, _dense_size, _array_segments_type,
                                               _array_segments, _array_indices_type,
                                               _array_indices);
}
                                         ...
                                         const flatbuffers::resolver_function_t *_resolver) const
{
  ...
  }
  {
    ...
    if (_e)
    {
      ...
      {
        _o->dim_metadata[_i] =
          std::unique_ptr<onert_tflite::DimensionMetadataT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  }
}
                         ...
                         const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _dim_metadata = _o->dim_metadata.size()
                         ? _fbb.CreateVector<flatbuffers::Offset<onert_tflite::DimensionMetadata>>(
                             ...
                             &_va)
                         : 0;
  return onert_tflite::CreateSparsityParameters(_fbb, _traversal_order, _block_map, _dim_metadata);
}
...
inline void Tensor::UnPackTo(TensorT *_o, const flatbuffers::resolver_function_t *_resolver) const
{
  ...
  }
  {
    ...
    if (_e)
      _o->quantization =
        std::unique_ptr<onert_tflite::QuantizationParametersT>(_e->UnPack(_resolver));
  }
  {
    auto _e = is_variable();
    _o->is_variable = _e;
  }
  {
    auto _e = sparsity();
    if (_e)
      _o->sparsity = std::unique_ptr<onert_tflite::SparsityParametersT>(_e->UnPack(_resolver));
  }
  {
                                                ...
                                                const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateTensor(_fbb, _shape, _type, _buffer, _name, _quantization,
                                    _is_variable, _sparsity, _shape_signature);
}
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateConv2DOptions(_fbb, _padding, _stride_w, _stride_h,
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _dilation_w_factor = _o->dilation_w_factor;
  auto _dilation_h_factor = _o->dilation_h_factor;
  return onert_tflite::CreateConv3DOptions(_fbb, _padding, _stride_d, _stride_w, _stride_h,
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _fused_activation_function = _o->fused_activation_function;
  return onert_tflite::CreatePool2DOptions(_fbb, _padding, _stride_w, _stride_h, _filter_width,
                             ...
                             const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _dilation_w_factor = _o->dilation_w_factor;
  auto _dilation_h_factor = _o->dilation_h_factor;
  return onert_tflite::CreateDepthwiseConv2DOptions(_fbb, _padding, _stride_w, _stride_h,
                              ...
                              const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateConcatEmbeddingsOptions(_fbb, _num_channels, _num_columns_per_channel,
                           ...
                           const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  auto _type = _o->type;
  return onert_tflite::CreateLSHProjectionOptions(_fbb, _type);
}
                  ...
                  const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateSVDFOptions(_fbb, _rank, _fused_activation_function,
                 ...
                 const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _fused_activation_function = _o->fused_activation_function;
  auto _asymmetric_quantize_inputs = _o->asymmetric_quantize_inputs;
  return onert_tflite::CreateRNNOptions(_fbb, _fused_activation_function,
                                        _asymmetric_quantize_inputs);
}
                         ...
                         const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _fused_activation_function = _o->fused_activation_function;
  auto _asymmetric_quantize_inputs = _o->asymmetric_quantize_inputs;
  return onert_tflite::CreateSequenceRNNOptions(_fbb, _time_major, _fused_activation_function,
                                                _asymmetric_quantize_inputs);
}
                                      ...
                                      const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _asymmetric_quantize_inputs = _o->asymmetric_quantize_inputs;
  return onert_tflite::CreateBidirectionalSequenceRNNOptions(
                            ...
                            const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _asymmetric_quantize_inputs = _o->asymmetric_quantize_inputs;
  return onert_tflite::CreateFullyConnectedOptions(
    _fbb, _fused_activation_function, _weights_format, _keep_num_dims, _asymmetric_quantize_inputs);
}
                     ...
                     const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  auto _beta = _o->beta;
  return onert_tflite::CreateSoftmaxOptions(_fbb, _beta);
}
                           ...
                           const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _axis = _o->axis;
  auto _fused_activation_function = _o->fused_activation_function;
  return onert_tflite::CreateConcatenationOptions(_fbb, _axis, _fused_activation_function);
}
                 ...
                 const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateAddOptions(_fbb, _fused_activation_function, _pot_scale_int16);
}
                 ...
                 const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  auto _fused_activation_function = _o->fused_activation_function;
  return onert_tflite::CreateMulOptions(_fbb, _fused_activation_function);
}
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  auto _fused_activation_function = _o->fused_activation_function;
  return onert_tflite::CreateL2NormOptions(_fbb, _fused_activation_function);
}
                                        ...
                                        const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _beta = _o->beta;
  return onert_tflite::CreateLocalResponseNormalizationOptions(_fbb, _radius, _bias, _alpha, _beta);
}
                  ...
                  const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _asymmetric_quantize_inputs = _o->asymmetric_quantize_inputs;
  return onert_tflite::CreateLSTMOptions(_fbb, _fused_activation_function, _cell_clip, _proj_clip,
                                        ...
                                        const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _time_major = _o->time_major;
  auto _asymmetric_quantize_inputs = _o->asymmetric_quantize_inputs;
  return onert_tflite::CreateUnidirectionalSequenceLSTMOptions(_fbb, _fused_activation_function,
                                       ...
                                       const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _time_major = _o->time_major;
  auto _asymmetric_quantize_inputs = _o->asymmetric_quantize_inputs;
  return onert_tflite::CreateBidirectionalSequenceLSTMOptions(
                            ...
                            const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateResizeBilinearOptions(_fbb, _align_corners, _half_pixel_centers);
}
                                   ...
                                   const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _align_corners = _o->align_corners;
  auto _half_pixel_centers = _o->half_pixel_centers;
  return onert_tflite::CreateResizeNearestNeighborOptions(_fbb, _align_corners,
                                                          _half_pixel_centers);
}
                  ...
                  const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateCallOptions(_fbb, _subgraph);
}
                 ...
                 const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreatePadOptions(_fbb);
}
                   ...
                   const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreatePadV2Options(_fbb);
}
                     ...
                     const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateReshapeOptions(_fbb, _new_shape);
}
                            ...
                            const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateSpaceToBatchNDOptions(_fbb);
}
                            ...
                            const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateBatchToSpaceNDOptions(_fbb);
}
                      ...
                      const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateSkipGramOptions(_fbb, _ngram_size, _max_skip_size,
                                             _include_all_ngrams);
}
                          ...
                          const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateSpaceToDepthOptions(_fbb, _block_size);
}
                          ...
                          const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  auto _block_size = _o->block_size;
  return onert_tflite::CreateDepthToSpaceOptions(_fbb, _block_size);
}
                 ...
                 const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _fused_activation_function = _o->fused_activation_function;
  auto _pot_scale_int16 = _o->pot_scale_int16;
  return onert_tflite::CreateSubOptions(_fbb, _fused_activation_function, _pot_scale_int16);
}
                 ...
                 const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  auto _fused_activation_function = _o->fused_activation_function;
  return onert_tflite::CreateDivOptions(_fbb, _fused_activation_function);
}
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateTopKV2Options(_fbb);
}
                                   ...
                                   const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateEmbeddingLookupSparseOptions(_fbb, _combiner);
}
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateGatherOptions(_fbb, _axis, _batch_dims);
}
                       ...
                       const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateTransposeOptions(_fbb);
}
                 ...
                 const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateExpOptions(_fbb);
}
                 ...
                 const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateCosOptions(_fbb);
}
                     ...
                     const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateReducerOptions(_fbb, _keep_dims);
}
                     ...
                     const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateSqueezeOptions(_fbb, _squeeze_dims);
}
                   ...
                   const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateSplitOptions(_fbb, _num_splits);
}
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  auto _num_splits = _o->num_splits;
  return onert_tflite::CreateSplitVOptions(_fbb, _num_splits);
}
                          ...
                          const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateStridedSliceOptions(_fbb, _begin_mask, _end_mask, _ellipsis_mask,
                        ...
                        const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateLogSoftmaxOptions(_fbb);
}
                  ...
                  const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateCastOptions(_fbb, _in_data_type, _out_data_type);
}
                        ...
                        const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateDequantizeOptions(_fbb);
}
                            ...
                            const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateMaximumMinimumOptions(_fbb);
}
                  ...
                  const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateTileOptions(_fbb);
}
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateArgMaxOptions(_fbb, _output_type);
}
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  auto _output_type = _o->output_type;
  return onert_tflite::CreateArgMinOptions(_fbb, _output_type);
}
                     ...
                     const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateGreaterOptions(_fbb);
}
                          ...
                          const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateGreaterEqualOptions(_fbb);
}
                  ...
                  const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateLessOptions(_fbb);
}
                       ...
                       const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateLessEqualOptions(_fbb);
}
                 ...
                 const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateNegOptions(_fbb);
}
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateSelectOptions(_fbb);
}
                   ...
                   const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateSliceOptions(_fbb);
}
                           ...
                           const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _stride_w = _o->stride_w;
  auto _stride_h = _o->stride_h;
  return onert_tflite::CreateTransposeConvOptions(_fbb, _padding, _stride_w, _stride_h);
}
                        ...
                        const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateExpandDimsOptions(_fbb);
}
                           ...
                           const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateSparseToDenseOptions(_fbb, _validate_indices);
}
                   ...
                   const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateEqualOptions(_fbb);
}
                      ...
                      const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateNotEqualOptions(_fbb);
}
                   ...
                   const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateShapeOptions(_fbb, _out_type);
}
                  ...
                  const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateRankOptions(_fbb);
}
                 ...
                 const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreatePowOptions(_fbb);
}
                       ...
                       const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateFakeQuantOptions(_fbb, _min, _max, _num_bits, _narrow_range);
}
                  ...
                  const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _axis = _o->axis;
  return onert_tflite::CreatePackOptions(_fbb, _values_count, _axis);
}
                       ...
                       const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateLogicalOrOptions(_fbb);
}
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  auto _axis = _o->axis;
  return onert_tflite::CreateOneHotOptions(_fbb, _axis);
}
                 ...
                 const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateAbsOptions(_fbb);
}
                       ...
                       const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateHardSwishOptions(_fbb);
}
                        ...
                        const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateLogicalAndOptions(_fbb);
}
                        ...
                        const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateLogicalNotOptions(_fbb);
}
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _num = _o->num;
  auto _axis = _o->axis;
  return onert_tflite::CreateUnpackOptions(_fbb, _num, _axis);
}
                      ...
                      const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateFloorDivOptions(_fbb);
}
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateSquareOptions(_fbb);
}
                       ...
                       const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateZerosLikeOptions(_fbb);
}
                  ...
                  const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateFillOptions(_fbb);
}
                      ...
                      const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateFloorModOptions(_fbb);
}
                   ...
                   const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateRangeOptions(_fbb);
}
                       ...
                       const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  auto _alpha = _o->alpha;
  return onert_tflite::CreateLeakyReluOptions(_fbb, _alpha);
}
                               ...
                               const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateSquaredDifferenceOptions(_fbb);
}
                       ...
                       const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  auto _mode = _o->mode;
  return onert_tflite::CreateMirrorPadOptions(_fbb, _mode);
}
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateUniqueOptions(_fbb, _idx_out_type);
}
                       ...
                       const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateReverseV2Options(_fbb);
}
                  ...
                  const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateAddNOptions(_fbb);
}
                      ...
                      const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateGatherNdOptions(_fbb);
}
                   ...
                   const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateWhereOptions(_fbb);
}
                             ...
                             const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateReverseSequenceOptions(_fbb, _seq_dim, _batch_dim);
}
                        ...
                        const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateMatrixDiagOptions(_fbb);
}
                      ...
                      const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateQuantizeOptions(_fbb);
}
                           ...
                           const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateMatrixSetDiagOptions(_fbb);
}
                ...
                const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateIfOptions(_fbb, _then_subgraph_index, _else_subgraph_index);
}
                      ...
                      const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateCallOnceOptions(_fbb, _init_subgraph_index);
}
                   ...
                   const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateWhileOptions(_fbb, _cond_subgraph_index, _body_subgraph_index);
}
                                 ...
                                 const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateNonMaxSuppressionV4Options(_fbb);
}
                                 ...
                                 const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateNonMaxSuppressionV5Options(_fbb);
}
                       ...
                       const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateScatterNdOptions(_fbb);
}
                      ...
                      const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateSelectV2Options(_fbb);
}
                     ...
                     const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateDensifyOptions(_fbb);
}
                        ...
                        const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateSegmentSumOptions(_fbb);
}
                         ...
                         const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _asymmetric_quantize_inputs = _o->asymmetric_quantize_inputs;
  return onert_tflite::CreateBatchMatMulOptions(_fbb, _adj_x, _adj_y, _asymmetric_quantize_inputs);
}
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateCumsumOptions(_fbb, _exclusive, _reverse);
}
                         ...
                         const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateBroadcastToOptions(_fbb);
}
                    ...
                    const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateRfft2dOptions(_fbb);
}
                       ...
                       const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateHashtableOptions(_fbb, _table_id, _key_dtype, _value_dtype);
}
                           ...
                           const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateHashtableFindOptions(_fbb);
}
                             ...
                             const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateHashtableImportOptions(_fbb);
}
                           ...
                           const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateHashtableSizeOptions(_fbb);
}
                       ...
                       const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateVarHandleOptions(_fbb, _container, _shared_name);
}
                          ...
                          const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateReadVariableOptions(_fbb);
}
                            ...
                            const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  (void)_va;
  return onert_tflite::CreateAssignVariableOptions(_fbb);
}
                   ...
                   const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateOperatorCode(_fbb, _deprecated_builtin_code, _custom_code, _version,
                                          _builtin_code);
}
  ...
  }
  {
    ...
    if (_e)
      _o->builtin_options.value =
        onert_tflite::BuiltinOptionsUnion::UnPack(_e, builtin_options_type(), _resolver);
  }
  {
               ...
               const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateOperator(_fbb, _opcode_index, _inputs, _outputs, _builtin_options_type,
                               ...
                               const flatbuffers::resolver_function_t *_resolver) const
{
  ...
  (void)_resolver;
  {
    ...
    if (_e)
    {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++)
      {
        _o->tensors[_i] = std::unique_ptr<onert_tflite::TensorT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  }
  {
  ...
  }
  {
    ...
    if (_e)
    {
      ...
      {
        _o->operators[_i] =
          std::unique_ptr<onert_tflite::OperatorT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  }
  {
               ...
               const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _tensors =
    _o->tensors.size()
      ? _fbb.CreateVector<flatbuffers::Offset<onert_tflite::Tensor>>(
          _o->tensors.size(),
          [](size_t i, _VectorArgs *__va) {
  ...
  auto _operators =
    _o->operators.size()
      ? _fbb.CreateVector<flatbuffers::Offset<onert_tflite::Operator>>(
          _o->operators.size(),
          [](size_t i, _VectorArgs *__va) {
      ...
      : 0;
  auto _name = _o->name.empty() ? 0 : _fbb.CreateString(_o->name);
  return onert_tflite::CreateSubGraph(_fbb, _tensors, _inputs, _outputs, _operators, _name);
}
                                                ...
                                                const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateBuffer(_fbb, _data);
}
               ...
               const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _name = _o->name.empty() ? 0 : _fbb.CreateString(_o->name);
  auto _buffer = _o->buffer;
  return onert_tflite::CreateMetadata(_fbb, _name, _buffer);
}
                ...
                const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  return onert_tflite::CreateTensorMap(_fbb, _name, _tensor_index);
}
                                   ...
                                   const flatbuffers::resolver_function_t *_resolver) const
{
  ...
  (void)_resolver;
  {
    ...
    if (_e)
    {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++)
      {
        _o->inputs[_i] = std::unique_ptr<onert_tflite::TensorMapT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  }
  {
    ...
    if (_e)
    {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++)
      {
        _o->outputs[_i] = std::unique_ptr<onert_tflite::TensorMapT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  }
  {
                   ...
                   const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _inputs =
    _o->inputs.size()
      ? _fbb.CreateVector<flatbuffers::Offset<onert_tflite::TensorMap>>(
          _o->inputs.size(),
          [](size_t i, _VectorArgs *__va) {
  ...
  return onert_tflite::CreateSignatureDef(_fbb, _inputs, _outputs, _method_name, _key,
                                          _subgraph_index);
}
...
inline void Model::UnPackTo(ModelT *_o, const flatbuffers::resolver_function_t *_resolver) const
{
    ...
    if (_e)
    {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++)
      {
        _o->operator_codes[_i] =
          std::unique_ptr<onert_tflite::OperatorCodeT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  }
  {
    ...
    if (_e)
    {
      ...
      {
        _o->subgraphs[_i] =
          std::unique_ptr<onert_tflite::SubGraphT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  }
  {
  ...
  }
  {
    ...
    if (_e)
    {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++)
      {
        _o->buffers[_i] = std::unique_ptr<onert_tflite::BufferT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  }
  {
  ...
  }
  {
    ...
    if (_e)
    {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++)
      {
        _o->metadata[_i] = std::unique_ptr<onert_tflite::MetadataT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  }
  {
    ...
    if (_e)
    {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++)
      {
        _o->signature_defs[_i] =
          std::unique_ptr<onert_tflite::SignatureDefT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  }
}
                                              ...
                                              const flatbuffers::rehasher_function_t *_rehasher)
{
  ...
  auto _operator_codes =
    _o->operator_codes.size()
      ? _fbb.CreateVector<flatbuffers::Offset<onert_tflite::OperatorCode>>(
          _o->operator_codes.size(),
          [](size_t i, _VectorArgs *__va) {
  ...
  auto _subgraphs =
    _o->subgraphs.size()
      ? _fbb.CreateVector<flatbuffers::Offset<onert_tflite::SubGraph>>(
          _o->subgraphs.size(),
          [](size_t i, _VectorArgs *__va) {
  ...
  auto _buffers =
    _o->buffers.size()
      ? _fbb.CreateVector<flatbuffers::Offset<onert_tflite::Buffer>>(
          _o->buffers.size(),
          [](size_t i, _VectorArgs *__va) {
  ...
  auto _metadata =
    _o->metadata.size()
      ? _fbb.CreateVector<flatbuffers::Offset<onert_tflite::Metadata>>(
          _o->metadata.size(),
          [](size_t i, _VectorArgs *__va) {
  ...
  auto _signature_defs =
    _o->signature_defs.size()
      ? _fbb.CreateVector<flatbuffers::Offset<onert_tflite::SignatureDef>>(
          _o->signature_defs.size(),
          [](size_t i, _VectorArgs *__va) {
          ...
          &_va)
      : 0;
  return onert_tflite::CreateModel(_fbb, _version, _operator_codes, _subgraphs, _description,
                                   _buffers, _metadata_buffer, _metadata, _signature_defs);
}
                               ...
                               const flatbuffers::rehasher_function_t *_rehasher) const
{
  switch (type)
  {
    case QuantizationDetails_CustomQuantization:
    {
      auto ptr = reinterpret_cast<const onert_tflite::CustomQuantizationT *>(value);
                         ...
                         value(nullptr)
{
  switch (type)
  {
    case QuantizationDetails_CustomQuantization:
    {
      value = new onert_tflite::CustomQuantizationT(
        *reinterpret_cast<onert_tflite::CustomQuantizationT *>(u.value));
      break;
    }
    default:
      break;
...
inline void QuantizationDetailsUnion::Reset()
{
  switch (type)
  {
    case QuantizationDetails_CustomQuantization:
    {
      auto ptr = reinterpret_cast<onert_tflite::CustomQuantizationT *>(value);
      delete ptr;
      break;
    }
    default:
                             ...
                             const flatbuffers::rehasher_function_t *_rehasher) const
{
  switch (type)
  {
    case SparseIndexVector_Int32Vector:
    {
      auto ptr = reinterpret_cast<const onert_tflite::Int32VectorT *>(value);
      return CreateInt32Vector(_fbb, ptr, _rehasher).Union();
    }
    case SparseIndexVector_Uint16Vector:
    {
      auto ptr = reinterpret_cast<const onert_tflite::Uint16VectorT *>(value);
      return CreateUint16Vector(_fbb, ptr, _rehasher).Union();
    }
    case SparseIndexVector_Uint8Vector:
    {
      auto ptr = reinterpret_cast<const onert_tflite::Uint8VectorT *>(value);
                         ...
                         value(nullptr)
{
  switch (type)
  {
    ...
    {
      value =
        new onert_tflite::Int32VectorT(*reinterpret_cast<onert_tflite::Int32VectorT *>(u.value));
      break;
    }
    case SparseIndexVector_Uint16Vector:
    {
      value =
        new onert_tflite::Uint16VectorT(*reinterpret_cast<onert_tflite::Uint16VectorT *>(u.value));
      break;
    }
    case SparseIndexVector_Uint8Vector:
    {
      value =
        new onert_tflite::Uint8VectorT(*reinterpret_cast<onert_tflite::Uint8VectorT *>(u.value));
      break;
    }
    default:
      break;
...
inline void SparseIndexVectorUnion::Reset()
{
  switch (type)
  {
    case SparseIndexVector_Int32Vector:
    {
      auto ptr = reinterpret_cast<onert_tflite::Int32VectorT *>(value);
      delete ptr;
      break;
    }
    case SparseIndexVector_Uint16Vector:
    {
      auto ptr = reinterpret_cast<onert_tflite::Uint16VectorT *>(value);
      delete ptr;
      break;
    }
    case SparseIndexVector_Uint8Vector:
    {
      auto ptr = reinterpret_cast<onert_tflite::Uint8VectorT *>(value);
      delete ptr;
      break;
    }
    default:
                          ...
                          const flatbuffers::rehasher_function_t *_rehasher) const
{
  switch (type)
  {
    case BuiltinOptions_Conv2DOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::Conv2DOptionsT *>(value);
      return CreateConv2DOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_DepthwiseConv2DOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::DepthwiseConv2DOptionsT *>(value);
      return CreateDepthwiseConv2DOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ConcatEmbeddingsOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ConcatEmbeddingsOptionsT *>(value);
      return CreateConcatEmbeddingsOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_LSHProjectionOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::LSHProjectionOptionsT *>(value);
      return CreateLSHProjectionOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_Pool2DOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::Pool2DOptionsT *>(value);
      return CreatePool2DOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SVDFOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SVDFOptionsT *>(value);
      return CreateSVDFOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_RNNOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::RNNOptionsT *>(value);
      return CreateRNNOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_FullyConnectedOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::FullyConnectedOptionsT *>(value);
      return CreateFullyConnectedOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SoftmaxOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SoftmaxOptionsT *>(value);
      return CreateSoftmaxOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ConcatenationOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ConcatenationOptionsT *>(value);
      return CreateConcatenationOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_AddOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::AddOptionsT *>(value);
      return CreateAddOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_L2NormOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::L2NormOptionsT *>(value);
      return CreateL2NormOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_LocalResponseNormalizationOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::LocalResponseNormalizationOptionsT *>(value);
      return CreateLocalResponseNormalizationOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_LSTMOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::LSTMOptionsT *>(value);
      return CreateLSTMOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ResizeBilinearOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ResizeBilinearOptionsT *>(value);
      return CreateResizeBilinearOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_CallOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::CallOptionsT *>(value);
      return CreateCallOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ReshapeOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ReshapeOptionsT *>(value);
      return CreateReshapeOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SkipGramOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SkipGramOptionsT *>(value);
      return CreateSkipGramOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SpaceToDepthOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SpaceToDepthOptionsT *>(value);
      return CreateSpaceToDepthOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_EmbeddingLookupSparseOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::EmbeddingLookupSparseOptionsT *>(value);
      return CreateEmbeddingLookupSparseOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_MulOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::MulOptionsT *>(value);
      return CreateMulOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_PadOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::PadOptionsT *>(value);
      return CreatePadOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_GatherOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::GatherOptionsT *>(value);
      return CreateGatherOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_BatchToSpaceNDOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::BatchToSpaceNDOptionsT *>(value);
      return CreateBatchToSpaceNDOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SpaceToBatchNDOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SpaceToBatchNDOptionsT *>(value);
      return CreateSpaceToBatchNDOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_TransposeOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::TransposeOptionsT *>(value);
      return CreateTransposeOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ReducerOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ReducerOptionsT *>(value);
      return CreateReducerOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SubOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SubOptionsT *>(value);
      return CreateSubOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_DivOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::DivOptionsT *>(value);
      return CreateDivOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SqueezeOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SqueezeOptionsT *>(value);
      return CreateSqueezeOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SequenceRNNOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SequenceRNNOptionsT *>(value);
      return CreateSequenceRNNOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_StridedSliceOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::StridedSliceOptionsT *>(value);
      return CreateStridedSliceOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ExpOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ExpOptionsT *>(value);
      return CreateExpOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_TopKV2Options:
    {
      auto ptr = reinterpret_cast<const onert_tflite::TopKV2OptionsT *>(value);
      return CreateTopKV2Options(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SplitOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SplitOptionsT *>(value);
      return CreateSplitOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_LogSoftmaxOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::LogSoftmaxOptionsT *>(value);
      return CreateLogSoftmaxOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_CastOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::CastOptionsT *>(value);
      return CreateCastOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_DequantizeOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::DequantizeOptionsT *>(value);
      return CreateDequantizeOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_MaximumMinimumOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::MaximumMinimumOptionsT *>(value);
      return CreateMaximumMinimumOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ArgMaxOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ArgMaxOptionsT *>(value);
      return CreateArgMaxOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_LessOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::LessOptionsT *>(value);
      return CreateLessOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_NegOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::NegOptionsT *>(value);
      return CreateNegOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_PadV2Options:
    {
      auto ptr = reinterpret_cast<const onert_tflite::PadV2OptionsT *>(value);
      return CreatePadV2Options(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_GreaterOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::GreaterOptionsT *>(value);
      return CreateGreaterOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_GreaterEqualOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::GreaterEqualOptionsT *>(value);
      return CreateGreaterEqualOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_LessEqualOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::LessEqualOptionsT *>(value);
      return CreateLessEqualOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SelectOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SelectOptionsT *>(value);
      return CreateSelectOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SliceOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SliceOptionsT *>(value);
      return CreateSliceOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_TransposeConvOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::TransposeConvOptionsT *>(value);
      return CreateTransposeConvOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SparseToDenseOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SparseToDenseOptionsT *>(value);
      return CreateSparseToDenseOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_TileOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::TileOptionsT *>(value);
      return CreateTileOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ExpandDimsOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ExpandDimsOptionsT *>(value);
      return CreateExpandDimsOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_EqualOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::EqualOptionsT *>(value);
      return CreateEqualOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_NotEqualOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::NotEqualOptionsT *>(value);
      return CreateNotEqualOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ShapeOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ShapeOptionsT *>(value);
      return CreateShapeOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_PowOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::PowOptionsT *>(value);
      return CreatePowOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ArgMinOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ArgMinOptionsT *>(value);
      return CreateArgMinOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_FakeQuantOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::FakeQuantOptionsT *>(value);
      return CreateFakeQuantOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_PackOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::PackOptionsT *>(value);
      return CreatePackOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_LogicalOrOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::LogicalOrOptionsT *>(value);
      return CreateLogicalOrOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_OneHotOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::OneHotOptionsT *>(value);
      return CreateOneHotOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_LogicalAndOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::LogicalAndOptionsT *>(value);
      return CreateLogicalAndOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_LogicalNotOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::LogicalNotOptionsT *>(value);
      return CreateLogicalNotOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_UnpackOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::UnpackOptionsT *>(value);
      return CreateUnpackOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_FloorDivOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::FloorDivOptionsT *>(value);
      return CreateFloorDivOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SquareOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SquareOptionsT *>(value);
      return CreateSquareOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ZerosLikeOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ZerosLikeOptionsT *>(value);
      return CreateZerosLikeOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_FillOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::FillOptionsT *>(value);
      return CreateFillOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_BidirectionalSequenceLSTMOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::BidirectionalSequenceLSTMOptionsT *>(value);
      return CreateBidirectionalSequenceLSTMOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_BidirectionalSequenceRNNOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::BidirectionalSequenceRNNOptionsT *>(value);
      return CreateBidirectionalSequenceRNNOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_UnidirectionalSequenceLSTMOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::UnidirectionalSequenceLSTMOptionsT *>(value);
      return CreateUnidirectionalSequenceLSTMOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_FloorModOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::FloorModOptionsT *>(value);
      return CreateFloorModOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_RangeOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::RangeOptionsT *>(value);
      return CreateRangeOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ResizeNearestNeighborOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ResizeNearestNeighborOptionsT *>(value);
      return CreateResizeNearestNeighborOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_LeakyReluOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::LeakyReluOptionsT *>(value);
      return CreateLeakyReluOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SquaredDifferenceOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SquaredDifferenceOptionsT *>(value);
      return CreateSquaredDifferenceOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_MirrorPadOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::MirrorPadOptionsT *>(value);
      return CreateMirrorPadOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_AbsOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::AbsOptionsT *>(value);
      return CreateAbsOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SplitVOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SplitVOptionsT *>(value);
      return CreateSplitVOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_UniqueOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::UniqueOptionsT *>(value);
      return CreateUniqueOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ReverseV2Options:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ReverseV2OptionsT *>(value);
      return CreateReverseV2Options(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_AddNOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::AddNOptionsT *>(value);
      return CreateAddNOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_GatherNdOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::GatherNdOptionsT *>(value);
      return CreateGatherNdOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_CosOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::CosOptionsT *>(value);
      return CreateCosOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_WhereOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::WhereOptionsT *>(value);
      return CreateWhereOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_RankOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::RankOptionsT *>(value);
      return CreateRankOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ReverseSequenceOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ReverseSequenceOptionsT *>(value);
      return CreateReverseSequenceOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_MatrixDiagOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::MatrixDiagOptionsT *>(value);
      return CreateMatrixDiagOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_QuantizeOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::QuantizeOptionsT *>(value);
      return CreateQuantizeOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_MatrixSetDiagOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::MatrixSetDiagOptionsT *>(value);
      return CreateMatrixSetDiagOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_HardSwishOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::HardSwishOptionsT *>(value);
      return CreateHardSwishOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_IfOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::IfOptionsT *>(value);
      return CreateIfOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_WhileOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::WhileOptionsT *>(value);
      return CreateWhileOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_DepthToSpaceOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::DepthToSpaceOptionsT *>(value);
      return CreateDepthToSpaceOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_NonMaxSuppressionV4Options:
    {
      auto ptr = reinterpret_cast<const onert_tflite::NonMaxSuppressionV4OptionsT *>(value);
      return CreateNonMaxSuppressionV4Options(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_NonMaxSuppressionV5Options:
    {
      auto ptr = reinterpret_cast<const onert_tflite::NonMaxSuppressionV5OptionsT *>(value);
      return CreateNonMaxSuppressionV5Options(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ScatterNdOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ScatterNdOptionsT *>(value);
      return CreateScatterNdOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SelectV2Options:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SelectV2OptionsT *>(value);
      return CreateSelectV2Options(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_DensifyOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::DensifyOptionsT *>(value);
      return CreateDensifyOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_SegmentSumOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::SegmentSumOptionsT *>(value);
      return CreateSegmentSumOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_BatchMatMulOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::BatchMatMulOptionsT *>(value);
      return CreateBatchMatMulOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_CumsumOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::CumsumOptionsT *>(value);
      return CreateCumsumOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_CallOnceOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::CallOnceOptionsT *>(value);
      return CreateCallOnceOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_BroadcastToOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::BroadcastToOptionsT *>(value);
      return CreateBroadcastToOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_Rfft2dOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::Rfft2dOptionsT *>(value);
      return CreateRfft2dOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_Conv3DOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::Conv3DOptionsT *>(value);
      return CreateConv3DOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_HashtableOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::HashtableOptionsT *>(value);
      return CreateHashtableOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_HashtableFindOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::HashtableFindOptionsT *>(value);
      return CreateHashtableFindOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_HashtableImportOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::HashtableImportOptionsT *>(value);
      return CreateHashtableImportOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_HashtableSizeOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::HashtableSizeOptionsT *>(value);
      return CreateHashtableSizeOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_VarHandleOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::VarHandleOptionsT *>(value);
      return CreateVarHandleOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_ReadVariableOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::ReadVariableOptionsT *>(value);
      return CreateReadVariableOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_AssignVariableOptions:
    {
      auto ptr = reinterpret_cast<const onert_tflite::AssignVariableOptionsT *>(value);
...
inline BuiltinOptionsUnion::BuiltinOptionsUnion(const BuiltinOptionsUnion &u) FLATBUFFERS_NOEXCEPT
  : type(u.type),
    value(nullptr)
{
  switch (type)
  {
    case BuiltinOptions_Conv2DOptions:
    {
      value = new onert_tflite::Conv2DOptionsT(
        *reinterpret_cast<onert_tflite::Conv2DOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_DepthwiseConv2DOptions:
    {
      value = new onert_tflite::DepthwiseConv2DOptionsT(
        *reinterpret_cast<onert_tflite::DepthwiseConv2DOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ConcatEmbeddingsOptions:
    {
      value = new onert_tflite::ConcatEmbeddingsOptionsT(
        *reinterpret_cast<onert_tflite::ConcatEmbeddingsOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_LSHProjectionOptions:
    {
      value = new onert_tflite::LSHProjectionOptionsT(
        *reinterpret_cast<onert_tflite::LSHProjectionOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_Pool2DOptions:
    {
      value = new onert_tflite::Pool2DOptionsT(
        *reinterpret_cast<onert_tflite::Pool2DOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SVDFOptions:
    {
      value =
        new onert_tflite::SVDFOptionsT(*reinterpret_cast<onert_tflite::SVDFOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_RNNOptions:
    {
      value =
        new onert_tflite::RNNOptionsT(*reinterpret_cast<onert_tflite::RNNOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_FullyConnectedOptions:
    {
      value = new onert_tflite::FullyConnectedOptionsT(
        *reinterpret_cast<onert_tflite::FullyConnectedOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SoftmaxOptions:
    {
      value = new onert_tflite::SoftmaxOptionsT(
        *reinterpret_cast<onert_tflite::SoftmaxOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ConcatenationOptions:
    {
      value = new onert_tflite::ConcatenationOptionsT(
        *reinterpret_cast<onert_tflite::ConcatenationOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_AddOptions:
    {
      value =
        new onert_tflite::AddOptionsT(*reinterpret_cast<onert_tflite::AddOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_L2NormOptions:
    {
      value = new onert_tflite::L2NormOptionsT(
        *reinterpret_cast<onert_tflite::L2NormOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_LocalResponseNormalizationOptions:
    {
      value = new onert_tflite::LocalResponseNormalizationOptionsT(
        *reinterpret_cast<onert_tflite::LocalResponseNormalizationOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_LSTMOptions:
    {
      value =
        new onert_tflite::LSTMOptionsT(*reinterpret_cast<onert_tflite::LSTMOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ResizeBilinearOptions:
    {
      value = new onert_tflite::ResizeBilinearOptionsT(
        *reinterpret_cast<onert_tflite::ResizeBilinearOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_CallOptions:
    {
      value =
        new onert_tflite::CallOptionsT(*reinterpret_cast<onert_tflite::CallOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ReshapeOptions:
    {
      value = new onert_tflite::ReshapeOptionsT(
        *reinterpret_cast<onert_tflite::ReshapeOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SkipGramOptions:
    {
      value = new onert_tflite::SkipGramOptionsT(
        *reinterpret_cast<onert_tflite::SkipGramOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SpaceToDepthOptions:
    {
      value = new onert_tflite::SpaceToDepthOptionsT(
        *reinterpret_cast<onert_tflite::SpaceToDepthOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_EmbeddingLookupSparseOptions:
    {
      value = new onert_tflite::EmbeddingLookupSparseOptionsT(
        *reinterpret_cast<onert_tflite::EmbeddingLookupSparseOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_MulOptions:
    {
      value =
        new onert_tflite::MulOptionsT(*reinterpret_cast<onert_tflite::MulOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_PadOptions:
    {
      value =
        new onert_tflite::PadOptionsT(*reinterpret_cast<onert_tflite::PadOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_GatherOptions:
    {
      value = new onert_tflite::GatherOptionsT(
        *reinterpret_cast<onert_tflite::GatherOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_BatchToSpaceNDOptions:
    {
      value = new onert_tflite::BatchToSpaceNDOptionsT(
        *reinterpret_cast<onert_tflite::BatchToSpaceNDOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SpaceToBatchNDOptions:
    {
      value = new onert_tflite::SpaceToBatchNDOptionsT(
        *reinterpret_cast<onert_tflite::SpaceToBatchNDOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_TransposeOptions:
    {
      value = new onert_tflite::TransposeOptionsT(
        *reinterpret_cast<onert_tflite::TransposeOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ReducerOptions:
    {
      value = new onert_tflite::ReducerOptionsT(
        *reinterpret_cast<onert_tflite::ReducerOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SubOptions:
    {
      value =
        new onert_tflite::SubOptionsT(*reinterpret_cast<onert_tflite::SubOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_DivOptions:
    {
      value =
        new onert_tflite::DivOptionsT(*reinterpret_cast<onert_tflite::DivOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SqueezeOptions:
    {
      value = new onert_tflite::SqueezeOptionsT(
        *reinterpret_cast<onert_tflite::SqueezeOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SequenceRNNOptions:
    {
      value = new onert_tflite::SequenceRNNOptionsT(
        *reinterpret_cast<onert_tflite::SequenceRNNOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_StridedSliceOptions:
    {
      value = new onert_tflite::StridedSliceOptionsT(
        *reinterpret_cast<onert_tflite::StridedSliceOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ExpOptions:
    {
      value =
        new onert_tflite::ExpOptionsT(*reinterpret_cast<onert_tflite::ExpOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_TopKV2Options:
    {
      value = new onert_tflite::TopKV2OptionsT(
        *reinterpret_cast<onert_tflite::TopKV2OptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SplitOptions:
    {
      value =
        new onert_tflite::SplitOptionsT(*reinterpret_cast<onert_tflite::SplitOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_LogSoftmaxOptions:
    {
      value = new onert_tflite::LogSoftmaxOptionsT(
        *reinterpret_cast<onert_tflite::LogSoftmaxOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_CastOptions:
    {
      value =
        new onert_tflite::CastOptionsT(*reinterpret_cast<onert_tflite::CastOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_DequantizeOptions:
    {
      value = new onert_tflite::DequantizeOptionsT(
        *reinterpret_cast<onert_tflite::DequantizeOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_MaximumMinimumOptions:
    {
      value = new onert_tflite::MaximumMinimumOptionsT(
        *reinterpret_cast<onert_tflite::MaximumMinimumOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ArgMaxOptions:
    {
      value = new onert_tflite::ArgMaxOptionsT(
        *reinterpret_cast<onert_tflite::ArgMaxOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_LessOptions:
    {
      value =
        new onert_tflite::LessOptionsT(*reinterpret_cast<onert_tflite::LessOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_NegOptions:
    {
      value =
        new onert_tflite::NegOptionsT(*reinterpret_cast<onert_tflite::NegOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_PadV2Options:
    {
      value =
        new onert_tflite::PadV2OptionsT(*reinterpret_cast<onert_tflite::PadV2OptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_GreaterOptions:
    {
      value = new onert_tflite::GreaterOptionsT(
        *reinterpret_cast<onert_tflite::GreaterOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_GreaterEqualOptions:
    {
      value = new onert_tflite::GreaterEqualOptionsT(
        *reinterpret_cast<onert_tflite::GreaterEqualOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_LessEqualOptions:
    {
      value = new onert_tflite::LessEqualOptionsT(
        *reinterpret_cast<onert_tflite::LessEqualOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SelectOptions:
    {
      value = new onert_tflite::SelectOptionsT(
        *reinterpret_cast<onert_tflite::SelectOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SliceOptions:
    {
      value =
        new onert_tflite::SliceOptionsT(*reinterpret_cast<onert_tflite::SliceOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_TransposeConvOptions:
    {
      value = new onert_tflite::TransposeConvOptionsT(
        *reinterpret_cast<onert_tflite::TransposeConvOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SparseToDenseOptions:
    {
      value = new onert_tflite::SparseToDenseOptionsT(
        *reinterpret_cast<onert_tflite::SparseToDenseOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_TileOptions:
    {
      value =
        new onert_tflite::TileOptionsT(*reinterpret_cast<onert_tflite::TileOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ExpandDimsOptions:
    {
      value = new onert_tflite::ExpandDimsOptionsT(
        *reinterpret_cast<onert_tflite::ExpandDimsOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_EqualOptions:
    {
      value =
        new onert_tflite::EqualOptionsT(*reinterpret_cast<onert_tflite::EqualOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_NotEqualOptions:
    {
      value = new onert_tflite::NotEqualOptionsT(
        *reinterpret_cast<onert_tflite::NotEqualOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ShapeOptions:
    {
      value =
        new onert_tflite::ShapeOptionsT(*reinterpret_cast<onert_tflite::ShapeOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_PowOptions:
    {
      value =
        new onert_tflite::PowOptionsT(*reinterpret_cast<onert_tflite::PowOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ArgMinOptions:
    {
      value = new onert_tflite::ArgMinOptionsT(
        *reinterpret_cast<onert_tflite::ArgMinOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_FakeQuantOptions:
    {
      value = new onert_tflite::FakeQuantOptionsT(
        *reinterpret_cast<onert_tflite::FakeQuantOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_PackOptions:
    {
      value =
        new onert_tflite::PackOptionsT(*reinterpret_cast<onert_tflite::PackOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_LogicalOrOptions:
    {
      value = new onert_tflite::LogicalOrOptionsT(
        *reinterpret_cast<onert_tflite::LogicalOrOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_OneHotOptions:
    {
      value = new onert_tflite::OneHotOptionsT(
        *reinterpret_cast<onert_tflite::OneHotOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_LogicalAndOptions:
    {
      value = new onert_tflite::LogicalAndOptionsT(
        *reinterpret_cast<onert_tflite::LogicalAndOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_LogicalNotOptions:
    {
      value = new onert_tflite::LogicalNotOptionsT(
        *reinterpret_cast<onert_tflite::LogicalNotOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_UnpackOptions:
    {
      value = new onert_tflite::UnpackOptionsT(
        *reinterpret_cast<onert_tflite::UnpackOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_FloorDivOptions:
    {
      value = new onert_tflite::FloorDivOptionsT(
        *reinterpret_cast<onert_tflite::FloorDivOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SquareOptions:
    {
      value = new onert_tflite::SquareOptionsT(
        *reinterpret_cast<onert_tflite::SquareOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ZerosLikeOptions:
    {
      value = new onert_tflite::ZerosLikeOptionsT(
        *reinterpret_cast<onert_tflite::ZerosLikeOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_FillOptions:
    {
      value =
        new onert_tflite::FillOptionsT(*reinterpret_cast<onert_tflite::FillOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_BidirectionalSequenceLSTMOptions:
    {
      value = new onert_tflite::BidirectionalSequenceLSTMOptionsT(
        *reinterpret_cast<onert_tflite::BidirectionalSequenceLSTMOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_BidirectionalSequenceRNNOptions:
    {
      value = new onert_tflite::BidirectionalSequenceRNNOptionsT(
        *reinterpret_cast<onert_tflite::BidirectionalSequenceRNNOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_UnidirectionalSequenceLSTMOptions:
    {
      value = new onert_tflite::UnidirectionalSequenceLSTMOptionsT(
        *reinterpret_cast<onert_tflite::UnidirectionalSequenceLSTMOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_FloorModOptions:
    {
      value = new onert_tflite::FloorModOptionsT(
        *reinterpret_cast<onert_tflite::FloorModOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_RangeOptions:
    {
      value =
        new onert_tflite::RangeOptionsT(*reinterpret_cast<onert_tflite::RangeOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ResizeNearestNeighborOptions:
    {
      value = new onert_tflite::ResizeNearestNeighborOptionsT(
        *reinterpret_cast<onert_tflite::ResizeNearestNeighborOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_LeakyReluOptions:
    {
      value = new onert_tflite::LeakyReluOptionsT(
        *reinterpret_cast<onert_tflite::LeakyReluOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SquaredDifferenceOptions:
    {
      value = new onert_tflite::SquaredDifferenceOptionsT(
        *reinterpret_cast<onert_tflite::SquaredDifferenceOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_MirrorPadOptions:
    {
      value = new onert_tflite::MirrorPadOptionsT(
        *reinterpret_cast<onert_tflite::MirrorPadOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_AbsOptions:
    {
      value =
        new onert_tflite::AbsOptionsT(*reinterpret_cast<onert_tflite::AbsOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SplitVOptions:
    {
      value = new onert_tflite::SplitVOptionsT(
        *reinterpret_cast<onert_tflite::SplitVOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_UniqueOptions:
    {
      value = new onert_tflite::UniqueOptionsT(
        *reinterpret_cast<onert_tflite::UniqueOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ReverseV2Options:
    {
      value = new onert_tflite::ReverseV2OptionsT(
        *reinterpret_cast<onert_tflite::ReverseV2OptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_AddNOptions:
    {
      value =
        new onert_tflite::AddNOptionsT(*reinterpret_cast<onert_tflite::AddNOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_GatherNdOptions:
    {
      value = new onert_tflite::GatherNdOptionsT(
        *reinterpret_cast<onert_tflite::GatherNdOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_CosOptions:
    {
      value =
        new onert_tflite::CosOptionsT(*reinterpret_cast<onert_tflite::CosOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_WhereOptions:
    {
      value =
        new onert_tflite::WhereOptionsT(*reinterpret_cast<onert_tflite::WhereOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_RankOptions:
    {
      value =
        new onert_tflite::RankOptionsT(*reinterpret_cast<onert_tflite::RankOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ReverseSequenceOptions:
    {
      value = new onert_tflite::ReverseSequenceOptionsT(
        *reinterpret_cast<onert_tflite::ReverseSequenceOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_MatrixDiagOptions:
    {
      value = new onert_tflite::MatrixDiagOptionsT(
        *reinterpret_cast<onert_tflite::MatrixDiagOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_QuantizeOptions:
    {
      value = new onert_tflite::QuantizeOptionsT(
        *reinterpret_cast<onert_tflite::QuantizeOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_MatrixSetDiagOptions:
    {
      value = new onert_tflite::MatrixSetDiagOptionsT(
        *reinterpret_cast<onert_tflite::MatrixSetDiagOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_HardSwishOptions:
    {
      value = new onert_tflite::HardSwishOptionsT(
        *reinterpret_cast<onert_tflite::HardSwishOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_IfOptions:
    {
      value = new onert_tflite::IfOptionsT(*reinterpret_cast<onert_tflite::IfOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_WhileOptions:
    {
      value =
        new onert_tflite::WhileOptionsT(*reinterpret_cast<onert_tflite::WhileOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_DepthToSpaceOptions:
    {
      value = new onert_tflite::DepthToSpaceOptionsT(
        *reinterpret_cast<onert_tflite::DepthToSpaceOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_NonMaxSuppressionV4Options:
    {
      value = new onert_tflite::NonMaxSuppressionV4OptionsT(
        *reinterpret_cast<onert_tflite::NonMaxSuppressionV4OptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_NonMaxSuppressionV5Options:
    {
      value = new onert_tflite::NonMaxSuppressionV5OptionsT(
        *reinterpret_cast<onert_tflite::NonMaxSuppressionV5OptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ScatterNdOptions:
    {
      value = new onert_tflite::ScatterNdOptionsT(
        *reinterpret_cast<onert_tflite::ScatterNdOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SelectV2Options:
    {
      value = new onert_tflite::SelectV2OptionsT(
        *reinterpret_cast<onert_tflite::SelectV2OptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_DensifyOptions:
    {
      value = new onert_tflite::DensifyOptionsT(
        *reinterpret_cast<onert_tflite::DensifyOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_SegmentSumOptions:
    {
      value = new onert_tflite::SegmentSumOptionsT(
        *reinterpret_cast<onert_tflite::SegmentSumOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_BatchMatMulOptions:
    {
      value = new onert_tflite::BatchMatMulOptionsT(
        *reinterpret_cast<onert_tflite::BatchMatMulOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_CumsumOptions:
    {
      value = new onert_tflite::CumsumOptionsT(
        *reinterpret_cast<onert_tflite::CumsumOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_CallOnceOptions:
    {
      value = new onert_tflite::CallOnceOptionsT(
        *reinterpret_cast<onert_tflite::CallOnceOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_BroadcastToOptions:
    {
      value = new onert_tflite::BroadcastToOptionsT(
        *reinterpret_cast<onert_tflite::BroadcastToOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_Rfft2dOptions:
    {
      value = new onert_tflite::Rfft2dOptionsT(
        *reinterpret_cast<onert_tflite::Rfft2dOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_Conv3DOptions:
    {
      value = new onert_tflite::Conv3DOptionsT(
        *reinterpret_cast<onert_tflite::Conv3DOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_HashtableOptions:
    {
      value = new onert_tflite::HashtableOptionsT(
        *reinterpret_cast<onert_tflite::HashtableOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_HashtableFindOptions:
    {
      value = new onert_tflite::HashtableFindOptionsT(
        *reinterpret_cast<onert_tflite::HashtableFindOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_HashtableImportOptions:
    {
      value = new onert_tflite::HashtableImportOptionsT(
        *reinterpret_cast<onert_tflite::HashtableImportOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_HashtableSizeOptions:
    {
      value = new onert_tflite::HashtableSizeOptionsT(
        *reinterpret_cast<onert_tflite::HashtableSizeOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_VarHandleOptions:
    {
      value = new onert_tflite::VarHandleOptionsT(
        *reinterpret_cast<onert_tflite::VarHandleOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_ReadVariableOptions:
    {
      value = new onert_tflite::ReadVariableOptionsT(
        *reinterpret_cast<onert_tflite::ReadVariableOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_AssignVariableOptions:
    {
      value = new onert_tflite::AssignVariableOptionsT(
        *reinterpret_cast<onert_tflite::AssignVariableOptionsT *>(u.value));
      break;
    }
    default:
      break;
...
inline void BuiltinOptionsUnion::Reset()
{
  switch (type)
  {
    case BuiltinOptions_Conv2DOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::Conv2DOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_DepthwiseConv2DOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::DepthwiseConv2DOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ConcatEmbeddingsOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ConcatEmbeddingsOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_LSHProjectionOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::LSHProjectionOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_Pool2DOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::Pool2DOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SVDFOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SVDFOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_RNNOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::RNNOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_FullyConnectedOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::FullyConnectedOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SoftmaxOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SoftmaxOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ConcatenationOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ConcatenationOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_AddOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::AddOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_L2NormOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::L2NormOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_LocalResponseNormalizationOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::LocalResponseNormalizationOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_LSTMOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::LSTMOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ResizeBilinearOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ResizeBilinearOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_CallOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::CallOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ReshapeOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ReshapeOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SkipGramOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SkipGramOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SpaceToDepthOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SpaceToDepthOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_EmbeddingLookupSparseOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::EmbeddingLookupSparseOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_MulOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::MulOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_PadOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::PadOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_GatherOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::GatherOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_BatchToSpaceNDOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::BatchToSpaceNDOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SpaceToBatchNDOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SpaceToBatchNDOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_TransposeOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::TransposeOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ReducerOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ReducerOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SubOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SubOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_DivOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::DivOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SqueezeOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SqueezeOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SequenceRNNOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SequenceRNNOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_StridedSliceOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::StridedSliceOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ExpOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ExpOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_TopKV2Options:
    {
      auto ptr = reinterpret_cast<onert_tflite::TopKV2OptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SplitOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SplitOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_LogSoftmaxOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::LogSoftmaxOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_CastOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::CastOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_DequantizeOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::DequantizeOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_MaximumMinimumOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::MaximumMinimumOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ArgMaxOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ArgMaxOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_LessOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::LessOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_NegOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::NegOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_PadV2Options:
    {
      auto ptr = reinterpret_cast<onert_tflite::PadV2OptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_GreaterOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::GreaterOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_GreaterEqualOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::GreaterEqualOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_LessEqualOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::LessEqualOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SelectOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SelectOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SliceOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SliceOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_TransposeConvOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::TransposeConvOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SparseToDenseOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SparseToDenseOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_TileOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::TileOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ExpandDimsOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ExpandDimsOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_EqualOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::EqualOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_NotEqualOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::NotEqualOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ShapeOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ShapeOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_PowOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::PowOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ArgMinOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ArgMinOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_FakeQuantOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::FakeQuantOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_PackOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::PackOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_LogicalOrOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::LogicalOrOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_OneHotOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::OneHotOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_LogicalAndOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::LogicalAndOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_LogicalNotOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::LogicalNotOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_UnpackOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::UnpackOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_FloorDivOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::FloorDivOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SquareOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SquareOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ZerosLikeOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ZerosLikeOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_FillOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::FillOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_BidirectionalSequenceLSTMOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::BidirectionalSequenceLSTMOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_BidirectionalSequenceRNNOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::BidirectionalSequenceRNNOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_UnidirectionalSequenceLSTMOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::UnidirectionalSequenceLSTMOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_FloorModOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::FloorModOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_RangeOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::RangeOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ResizeNearestNeighborOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ResizeNearestNeighborOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_LeakyReluOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::LeakyReluOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SquaredDifferenceOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SquaredDifferenceOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_MirrorPadOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::MirrorPadOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_AbsOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::AbsOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SplitVOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SplitVOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_UniqueOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::UniqueOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ReverseV2Options:
    {
      auto ptr = reinterpret_cast<onert_tflite::ReverseV2OptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_AddNOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::AddNOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_GatherNdOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::GatherNdOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_CosOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::CosOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_WhereOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::WhereOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_RankOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::RankOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ReverseSequenceOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ReverseSequenceOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_MatrixDiagOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::MatrixDiagOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_QuantizeOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::QuantizeOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_MatrixSetDiagOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::MatrixSetDiagOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_HardSwishOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::HardSwishOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_IfOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::IfOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_WhileOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::WhileOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_DepthToSpaceOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::DepthToSpaceOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_NonMaxSuppressionV4Options:
    {
      auto ptr = reinterpret_cast<onert_tflite::NonMaxSuppressionV4OptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_NonMaxSuppressionV5Options:
    {
      auto ptr = reinterpret_cast<onert_tflite::NonMaxSuppressionV5OptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ScatterNdOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ScatterNdOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SelectV2Options:
    {
      auto ptr = reinterpret_cast<onert_tflite::SelectV2OptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_DensifyOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::DensifyOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_SegmentSumOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::SegmentSumOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_BatchMatMulOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::BatchMatMulOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_CumsumOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::CumsumOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_CallOnceOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::CallOnceOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_BroadcastToOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::BroadcastToOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_Rfft2dOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::Rfft2dOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_Conv3DOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::Conv3DOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_HashtableOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::HashtableOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_HashtableFindOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::HashtableFindOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_HashtableImportOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::HashtableImportOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_HashtableSizeOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::HashtableSizeOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_VarHandleOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::VarHandleOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_ReadVariableOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::ReadVariableOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_AssignVariableOptions:
    {
      auto ptr = reinterpret_cast<onert_tflite::AssignVariableOptionsT *>(value);
      delete ptr;
      break;
    }
    default:
...
inline std::unique_ptr<onert_tflite::ModelT>
UnPackModel(const void *buf, const flatbuffers::resolver_function_t *res = nullptr)
{
  return std::unique_ptr<onert_tflite::ModelT>(GetModel(buf)->UnPack(res));
}

inline std::unique_ptr<onert_tflite::ModelT>
UnPackSizePrefixedModel(const void *buf, const flatbuffers::resolver_function_t *res = nullptr)
{
  return std::unique_ptr<onert_tflite::ModelT>(GetSizePrefixedModel(buf)->UnPack(res));
}

} // namespace onert_tflite

#endif // FLATBUFFERS_GENERATED_TFLITESCHEMA_TFLITE_H_
