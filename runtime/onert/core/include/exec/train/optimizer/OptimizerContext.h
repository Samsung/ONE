...
/**
 * @class   Opimizer Context class that can be used for applying gradient
...
public:
  ...
  /**
   * @brief Get the trainable tensor object to be updated
   *
   * @return ITrainableTensor Reference to the trainable tensor
   */
  backend::train::ITrainableTensor &getTrainable() { return _trainable; }

  /**
   * @brief Get the gradient tensor object to be used for applying gradient
   *
   * @return ITensor Reference to the grad tensor
   */
  const backend::IPortableTensor &getGradient() const { return _gradient; }
...
private:
  const backend::IPortableTensor &_gradient; /**< gradient tensor to be used in an optimizer */
  backend::train::ITrainableTensor
    &_trainable;    /**< trainable tensor to be updated by an optimizer */
