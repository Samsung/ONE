...
#ifndef __ONERT_BACKEND_TRAIN_ITRAINABLE_TENSOR_REGISTRY__
#define __ONERT_BACKEND_TRAIN_ITRAINABLE_TENSOR_REGISTRY__
...
#endif // __ONERT_BACKEND_TRAIN_ITRAINABLE_TENSOR_REGISTRY__
