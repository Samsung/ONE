...
public:
  ...
  // It is not yet determined how to get the information of the previous activation.
  // If it is determined to get from the user, we should consider whether to merge this enum class
  // and the `Type` enum class.
