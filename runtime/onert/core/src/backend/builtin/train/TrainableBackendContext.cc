...
ITensorRegistry *TrainableBackendContext::genTensors()
{
  return basic::genTensors(*this, _tensor_builder);
}

ITensorRegistry *TrainableBackendContext::genTrainingTensors()
{
  genGradTensors();
...
void TrainableBackendContext::genGradTensors()
{
...
backend::train::FunctionMap TrainableBackendContext::genKernels()
{
