...
{
  // TODO Insert Operations for training
  // TODO Create executors for training
  // TODO Return artifact of TrainingCompiler
  // return std::make_shared<CompilerArtifact>(executors,
  // std::move(compiler_artifact->tracing_ctx));
  /***************************************************
