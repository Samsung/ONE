...
void setBackendOptionPerOP(compiler::ManualSchedulerOptions &ms_options, const ir::Subgraphs &subgs,
...
#undef OP
    ...
    setBackendOptionPerOP(ms_options, subgs, map_str);
  }
  return options;
}
...
void Compiler::set_backend_from_str(const char *backend_settings)
{
  ...
  setBackendOptionPerOP(ms_options, *_subgraphs, std::string{backend_settings});
}
