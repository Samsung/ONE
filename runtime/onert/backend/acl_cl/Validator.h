...
private:
  ...
  void visit(const ir::operation::ConvertFp16ToFp32 &) override { _supported = true; }
  void visit(const ir::operation::ConvertFp32ToFp16 &) override { _supported = true; }
  ...
  void visit(const ir::operation::ResizeNearestNeighbor &) override { _supported = true; }
