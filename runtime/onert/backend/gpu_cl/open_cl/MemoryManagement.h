...
#ifndef __ONERT_BACKEND_GPU_CL_OPENCL_MEMORY_MANAGEMENT_H__
#define __ONERT_BACKEND_GPU_CL_OPENCL_MEMORY_MANAGEMENT_H__
...
#endif // __ONERT_BACKEND_GPU_CL_OPENCL_MEMORY_MANAGEMENT_H__
