...
extern CL_API_ENTRY cl_int CL_API_CALL clSetProgramReleaseCallback(
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueReadBufferRect(
  ...
  const size_t *host_offset, const size_t *region, size_t buffer_row_pitch,
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueCopyBuffer(
  ...
  size_t dst_offset, size_t size, cl_uint num_events_in_wait_list, const cl_event *event_wait_list,
...
extern CL_API_ENTRY CL_EXT_PREFIX__VERSION_1_1_DEPRECATED cl_int CL_API_CALL clEnqueueMarker(
  cl_command_queue command_queue, cl_event *event) CL_EXT_SUFFIX__VERSION_1_1_DEPRECATED;
