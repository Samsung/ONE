...
#ifndef __ONERT_BACKEND_GPU_CL_OPENCL_MEMORY_MANAGEMENT_NAIVE_ASSIGNMENT_H__
#define __ONERT_BACKEND_GPU_CL_OPENCL_MEMORY_MANAGEMENT_NAIVE_ASSIGNMENT_H__
...
absl::Status NaiveAssignment(const std::vector<TensorUsageRecord<TensorSizeT>> &usage_records,
...
#endif // __ONERT_BACKEND_GPU_CL_OPENCL_MEMORY_MANAGEMENT_NAIVE_ASSIGNMENT_H__
