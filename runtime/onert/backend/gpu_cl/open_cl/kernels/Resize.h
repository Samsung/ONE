...
#ifndef __ONERT_BACKEND_GPU_CL_OPENCL_KERNELS_RESIZE_H__
#define __ONERT_BACKEND_GPU_CL_OPENCL_KERNELS_RESIZE_H__
...
public:
  ...
  friend Resize CreateResize(const OperationDef &definition, const Resize2DAttributes &attr);

private:
  Resize(const OperationDef &definition, const Resize2DAttributes &attr);

  std::string GetResizeCode(const OperationDef &op_def, const Resize2DAttributes &attr);
...
#endif // __ONERT_BACKEND_GPU_CL_OPENCL_KERNELS_RESIZE_H__
