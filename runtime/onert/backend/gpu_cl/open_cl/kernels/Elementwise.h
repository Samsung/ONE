...
#ifndef __ONERT_BACKEND_GPU_CL_OPENCL_KERNELS_ELEMENTWISE_H__
#define __ONERT_BACKEND_GPU_CL_OPENCL_KERNELS_ELEMENTWISE_H__
...
#endif // __ONERT_BACKEND_GPU_CL_OPENCL_KERNELS_ELEMENTWISE_H__
