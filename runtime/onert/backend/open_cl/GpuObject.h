...
public:
  ...
  virtual bool PerformSelector(const std::string &selector, const std::vector<std::string> &args,
  ...
  virtual bool CreateGPUObject(CLContext *context, std::unique_ptr<GPUObject> *result) const
  {
    (void)context;
    (void)result;
    return true;
...
public:
  ...
  virtual bool GetGPUResources(const GPUObjectDescriptor *obj_ptr,
