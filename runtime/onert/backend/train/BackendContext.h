...
class UntrainableBackendContext : public backend::BackendContext
{
public:
  UntrainableBackendContext(const Backend *backend, ContextData &&data,
...
private:
  void planTensors(const std::vector<ir::OperationIndex> &order,
