...
convertElementwiseActivationType(ir::operation::ElementwiseActivation::Type type_ir)
{
  switch (type_ir)
  {
    ...
    default:
      throw std::runtime_error("training KernelGenerator : Not supported operation yet");
  }
}
...
// TODO Resolve code duplication with cpu::KernelGenerator for each operation
// TODO Generate ITrainableFunction for each operation
