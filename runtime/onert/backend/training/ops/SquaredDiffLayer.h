...
#ifndef __ONERT_BACKEND_TRAINING_OPS_SQDIFFLAYER_H__
#define __ONERT_BACKEND_TRAINING_OPS_SQDIFFLAYER_H__
...
#endif // __ONERT_BACKEND_TRAINING_OPS_SQDIFFLAYER_H__
