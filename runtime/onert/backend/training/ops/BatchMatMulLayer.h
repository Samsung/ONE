...
#ifndef __ONERT_BACKEND_TRAINING_OPS_BATCH_MATMUL_LAYER_H__
#define __ONERT_BACKEND_TRAINING_OPS_BATCH_MATMUL_LAYER_H__
...
#endif // __ONERT_BACKEND_TRAINING_OPS_BATCH_MATMUL_LAYER_H__
