...
#ifndef __ONERT_BACKEND_TRAINING_OPS_ARGMINMAXLAYER_H__
#define __ONERT_BACKEND_TRAINING_OPS_ARGMINMAXLAYER_H__
...
#endif // __ONERT_BACKEND_TRAINING_OPS_ARGMINMAXLAYER_H__
