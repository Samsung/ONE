...
#ifndef __ONERT_BACKEND_TRAINING_OPS_GATHERLAYER_H__
#define __ONERT_BACKEND_TRAINING_OPS_GATHERLAYER_H__
...
#endif // __ONERT_BACKEND_TRAINING_OPS_GATHERLAYER_H__
