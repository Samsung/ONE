...
#ifndef __ONERT_BACKEND_TRAINING_OPS_MATRIXBANDPARTLAYER_H__
#define __ONERT_BACKEND_TRAINING_OPS_MATRIXBANDPARTLAYER_H__
...
#endif // __ONERT_BACKEND_TRAINING_OPS_MATRIXBANDPARTLAYER_H__
