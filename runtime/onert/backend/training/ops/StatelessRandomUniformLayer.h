...
#ifndef __ONERT_BACKEND_TRAINING_OPS_STATELESS_RANDOM_UNIFORM_H__
#define __ONERT_BACKEND_TRAINING_OPS_STATELESS_RANDOM_UNIFORM_H__
...
#endif // __ONERT_BACKEND_TRAINING_OPS_STATELESS_RANDOM_UNIFORM_H__
