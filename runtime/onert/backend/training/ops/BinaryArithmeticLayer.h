...
#ifndef __ONERT_BACKEND_TRAINING_OPS_BINARYARITHMETICLAYER_H__
#define __ONERT_BACKEND_TRAINING_OPS_BINARYARITHMETICLAYER_H__
...
#endif // __ONERT_BACKEND_TRAINING_OPS_BINARYARITHMETICLAYER_H__
