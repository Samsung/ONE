...
#ifndef __ONERT_BACKEND_TRAINING_OPS_CONCATLAYER_H__
#define __ONERT_BACKEND_TRAINING_OPS_CONCATLAYER_H__
...
#endif // __ONERT_BACKEND_TRAINING_OPS_CONCATLAYER_H__
