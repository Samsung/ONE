...
#ifndef __ONERT_BACKEND_TRAINING_OPS_STRIDEDSLICELAYER_H__
#define __ONERT_BACKEND_TRAINING_OPS_STRIDEDSLICELAYER_H__
...
#endif // __ONERT_BACKEND_TRAINING_OPS_STRIDEDSLICELAYER_H__
