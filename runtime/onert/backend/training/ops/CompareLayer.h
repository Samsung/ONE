...
#ifndef __ONERT_BACKEND_TRAINING_OPS_COMPARELAYER_H__
#define __ONERT_BACKEND_TRAINING_OPS_COMPARELAYER_H__
...
#endif // __ONERT_BACKEND_TRAINING_OPS_COMPARELAYER_H__
