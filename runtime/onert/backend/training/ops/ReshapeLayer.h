...
#include <ops/ReshapeLayer.h> // From cpu backend
...
class ReshapeLayer : public exec::ITrainableFunction, public cpu::ops::ReshapeLayer
{
public:
  ReshapeLayer();
...
#endif // __ONERT_BACKEND_TRAINING_OPS_RESHAPELAYER_H__
