...
#include <ops/ConvolutionLayer.h> // From cpu backend
...
class ConvolutionLayer : public exec::ITrainableFunction, public cpu::ops::ConvolutionLayer
{
public:
  ConvolutionLayer();
  ~ConvolutionLayer();
...
public:
  void configure(const IPortableTensor *input, const IPortableTensor *ernel,
...
#endif // __ONERT_BACKEND_TRAINING_OPS_CONVOLUTIONLAYER_H__
