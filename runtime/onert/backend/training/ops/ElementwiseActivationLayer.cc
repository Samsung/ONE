                                           ...
                                           ElementwiseActivationType op_type)
{
  switch (op_type)
  {
    case ElementwiseActivationType::kReLU:
      ...
      break;
    default:
      throw std::runtime_error("training ElementwiseActivationLayer : Unsupported activation type");
  }
}

void ElementwiseActivationLayer::forwarding(bool) { cpu::ops::ElementwiseActivationLayer::run(); }
