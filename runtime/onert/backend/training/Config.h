...
#ifndef __ONERT_BACKEND_TRAINING_CONFIG_H__
#define __ONERT_BACKEND_TRAINING_CONFIG_H__
...
{
public:
  std::string id() override { return "training"; }
...
#endif // __ONERT_BACKEND_TRAINING_CONFIG_H__
