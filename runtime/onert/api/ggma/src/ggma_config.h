...
#ifndef __API_GGMA_CONFIG_H__
#define __API_GGMA_CONFIG_H__
...
struct GGMAConfig
{
  ...
  bool share_unemb_weights = false; // Whether prefill and decode share unemb weights
};
