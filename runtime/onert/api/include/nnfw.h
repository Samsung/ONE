 ...
 * To get the result of it {@nnfw_run_wait} must be called</p>
 *
 * @param[in] session The session to run inference
 * @return    @c NNFW_STATUS_NO_ERROR if successful
 */
 ...
 *
 * <p>When this function returns, it means that this session has finished
 * the asynchronous run. Then the user can safely use the output data.</p>
 *
 * <p>This function return after the asynchronous inference is finished.</p>
 *
 * @param[in] session The session to run inference
 * @return    @c NNFW_STATUS_NO_ERROR if successful
 */
