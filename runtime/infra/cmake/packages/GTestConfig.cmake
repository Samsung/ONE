...
if(${GTEST_FOUND})
  ...
  if(GTEST_INCLUDE_DIR AND GMOCK_INCLUDE_DIR AND GMOCK_LIBRARIES AND GMOCK_MAIN_LIBRARIES)
    if(NOT TARGET gmock)
      add_library(gmock INTERFACE)
    ...
    set(GTest_FOUND TRUE)
  endif(GTEST_INCLUDE_DIR AND GMOCK_INCLUDE_DIR AND GMOCK_LIBRARIES AND GMOCK_MAIN_LIBRARIES)
endif(${GTEST_FOUND})
