...
The current NNFW API test implementation has all operator tests in a single executable file (`nnfw_api_gtest`), causing excessive linking time (10+ minutes). With 165+ supported operators and growing, this approach doesn't scale well.
