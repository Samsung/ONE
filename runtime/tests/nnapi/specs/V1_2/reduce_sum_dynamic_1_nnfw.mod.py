...
'''
Testing ReduceSum op when the input is dynamic.
...
# write REDUCE_SUM test. input is `test_input`
...
model.Operation("REDUCE_SUM", test_node_input, axis, keepDims).To(model_output)

model_input_data = [1.0, 2.0, 3.0, 4.0,
           1.0, 2.0, 3.0, 4.0,
           1.0, 2.0, 3.0, 4.0]

model_output_data = [10.0, 10.0, 10.0]
