...
/**
 * @brief Creates a context from a GGMA package.
 *
 * This function initializes a context for inference, taking ownership of the
 * provided GGMA package. The context will manage the lifecycle of the package.
 ...
 * @param[in]   pkg     The GGMA package to use for creating the context. The context
 *                      will take ownership of this package.
 * @return      @c GGMA_STATUS_NO_ERROR on success, or an appropriate error code on failure.
 */
GGMA_STATUS ggma_create_context(ggma_context **context, struct ggma_package *pkg);
