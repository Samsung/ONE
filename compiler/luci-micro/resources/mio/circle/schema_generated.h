...
struct BuiltinOptionsUnion {
  ...
  BCQGatherOptionsT *AsBCQGatherOptions() {
    return type == BuiltinOptions_BCQGatherOptions ?
      reinterpret_cast<BCQGatherOptionsT *>(value) : nullptr;
  }
  const BCQGatherOptionsT *AsBCQGatherOptions() const {
    return type == BuiltinOptions_BCQGatherOptions ?
      reinterpret_cast<const BCQGatherOptionsT *>(value) : nullptr;
  }
  BCQFullyConnectedOptionsT *AsBCQFullyConnectedOptions() {
    return type == BuiltinOptions_BCQFullyConnectedOptions ?
      reinterpret_cast<BCQFullyConnectedOptionsT *>(value) : nullptr;
  }
  const BCQFullyConnectedOptionsT *AsBCQFullyConnectedOptions() const {
    return type == BuiltinOptions_BCQFullyConnectedOptions ?
      reinterpret_cast<const BCQFullyConnectedOptionsT *>(value) : nullptr;
  }
  InstanceNormOptionsT *AsInstanceNormOptions() {
    return type == BuiltinOptions_InstanceNormOptions ?
      reinterpret_cast<InstanceNormOptionsT *>(value) : nullptr;
  }
  const InstanceNormOptionsT *AsInstanceNormOptions() const {
    return type == BuiltinOptions_InstanceNormOptions ?
      reinterpret_cast<const InstanceNormOptionsT *>(value) : nullptr;
  }
};
...
inline flatbuffers::Offset<Uint16Vector> CreateUint16VectorDirect(
  ...
  return circle::CreateUint16Vector(
      _fbb,
      values ? _fbb.CreateVector<uint16_t>(*values) : 0);
}
...
struct BCQFullyConnectedOptionsT : public flatbuffers::NativeTable {
  ...
  int32_t weights_hidden_size;
  ActivationFunctionType fused_activation_function;
  BCQFullyConnectedOptionsT()
      : weights_hidden_size(0),
        fused_activation_function(ActivationFunctionType_NONE) {
  }
};
...
struct OperatorCode FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_BUILTIN_CODE) &&
...
struct Operator FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const BCQGatherOptions *builtin_options_as_BCQGatherOptions() const {
    return builtin_options_type() == BuiltinOptions_BCQGatherOptions ? static_cast<const BCQGatherOptions *>(builtin_options()) : nullptr;
  }
  const BCQFullyConnectedOptions *builtin_options_as_BCQFullyConnectedOptions() const {
    return builtin_options_type() == BuiltinOptions_BCQFullyConnectedOptions ? static_cast<const BCQFullyConnectedOptions *>(builtin_options()) : nullptr;
  }
  const InstanceNormOptions *builtin_options_as_InstanceNormOptions() const {
    return builtin_options_type() == BuiltinOptions_InstanceNormOptions ? static_cast<const InstanceNormOptions *>(builtin_options()) : nullptr;
  }
...
template<> inline const BCQFullyConnectedOptions *Operator::builtin_options_as<BCQFullyConnectedOptions>() const {
  return builtin_options_as_BCQFullyConnectedOptions();
}

template<> inline const InstanceNormOptions *Operator::builtin_options_as<InstanceNormOptions>() const {
...
struct SubGraphT : public flatbuffers::NativeTable {
  ...
  SubGraphT()
      : data_format(DataFormat_CHANNELS_LAST) {
  }
};
...
inline BCQFullyConnectedOptionsT *BCQFullyConnectedOptions::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = new BCQFullyConnectedOptionsT();
  UnPackTo(_o, _resolver);
  return _o;
}
...
inline InstanceNormOptionsT *InstanceNormOptions::UnPack(const flatbuffers::resolver_function_t *_resolver) const {
  auto _o = new InstanceNormOptionsT();
  UnPackTo(_o, _resolver);
  return _o;
}
...
inline flatbuffers::Offset<void> BuiltinOptionsUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  switch (type) {
    ...
    case BuiltinOptions_BCQGatherOptions: {
      auto ptr = reinterpret_cast<const BCQGatherOptionsT *>(value);
      return CreateBCQGatherOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_BCQFullyConnectedOptions: {
      auto ptr = reinterpret_cast<const BCQFullyConnectedOptionsT *>(value);
      return CreateBCQFullyConnectedOptions(_fbb, ptr, _rehasher).Union();
    }
    case BuiltinOptions_InstanceNormOptions: {
      auto ptr = reinterpret_cast<const InstanceNormOptionsT *>(value);
...
inline BuiltinOptionsUnion::BuiltinOptionsUnion(const BuiltinOptionsUnion &u) FLATBUFFERS_NOEXCEPT : type(u.type), value(nullptr) {
  switch (type) {
    ...
    case BuiltinOptions_BCQGatherOptions: {
      value = new BCQGatherOptionsT(*reinterpret_cast<BCQGatherOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_BCQFullyConnectedOptions: {
      value = new BCQFullyConnectedOptionsT(*reinterpret_cast<BCQFullyConnectedOptionsT *>(u.value));
      break;
    }
    case BuiltinOptions_InstanceNormOptions: {
      value = new InstanceNormOptionsT(*reinterpret_cast<InstanceNormOptionsT *>(u.value));
      break;
    }
    default:
      break;
...
inline void BuiltinOptionsUnion::Reset() {
  switch (type) {
    ...
    case BuiltinOptions_BCQGatherOptions: {
      auto ptr = reinterpret_cast<BCQGatherOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_BCQFullyConnectedOptions: {
      auto ptr = reinterpret_cast<BCQFullyConnectedOptionsT *>(value);
      delete ptr;
      break;
    }
    case BuiltinOptions_InstanceNormOptions: {
      auto ptr = reinterpret_cast<InstanceNormOptionsT *>(value);
      delete ptr;
      break;
    }
    default: break;
