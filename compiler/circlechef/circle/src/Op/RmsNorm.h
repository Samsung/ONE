...
#ifndef __CIRCLE_OP_RMS_NORM_H__
#define __CIRCLE_OP_RMS_NORM_H__
...
/**
 * @brief circlechef operator builder for RMS_NORM
 */
class CircleOpRmsNorm : public CircleOpChef
{
public:
...
#endif // __CIRCLE_OP_RMS_NORM_H__
