...
#ifndef __OP_RMS_NORM_H__
#define __OP_RMS_NORM_H__

#include "OpChef.h"

class RmsNormChef final : public OpChef
{
public:
  explicit RmsNormChef(const circlechef::Operation *operation) : _operation{operation}
  {
    // DO NOTHING
  }
