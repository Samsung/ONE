...
{
static inline void LocalResponseNormalization(const tflite::LocalResponseNormalizationParams& op_params,
                                              const tflite::RuntimeShape& input_shape, const float* input_data,
                                              const tflite::RuntimeShape& output_shape, float* output_data)
{
  tflite::optimized_ops::LocalResponseNormalization(op_params, input_shape, input_data, output_shape, output_data);
}
}
