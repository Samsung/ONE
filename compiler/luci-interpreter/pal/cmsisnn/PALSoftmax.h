...
namespace luci_interpreter_pal {
    ...
    template<typename T>
    inline void Softmax(const tflite::SoftmaxParams &params,
    ...
    inline void Softmax<int8_t>(const tflite::SoftmaxParams &params,
        ...
        const int32_t num_rows = 0;
        const int32_t row_size = 0;
        ...
        arm_softmax_s8(input_data, num_rows, row_size, mult, shift, diff_min, output_data);
    }
} // namespace luci_interpreter_pal
