...
static inline void InitializeParams(tflite::SoftmaxParams *params, float input_scale, float beta)
{
  ...
  tflite::PreprocessLogSoftmaxScalingExp(
    beta, input_scale, kScaledDiffIntegerBits, &params->input_multiplier, &params->input_left_shift,
    &params->reverse_scaling_divisor, &params->reverse_scaling_right_shift);
...
{
  (void)input_scale;
  tflite::reference_ops::LogSoftmax(params, input_shape, input_data, output_shape, output_data);
}
} // namespace luci_interpreter_pal
