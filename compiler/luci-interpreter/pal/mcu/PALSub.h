...
{
template <typename T>
static inline void Sub(const tflite::ArithmeticParams& params, const tflite::RuntimeShape& input1_shape,
                       const T* input1_data, const tflite::RuntimeShape& input2_shape,
                       const T* input2_data, const tflite::RuntimeShape& output_shape,
                       T* output_data)
{
  tflite::reference_ops::Sub(params, input1_shape, input1_data,
