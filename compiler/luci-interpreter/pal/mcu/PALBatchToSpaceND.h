...
{
template <typename T>
static inline void BatchToSpaceND(const tflite::RuntimeShape& unextended_input1_shape, const T* input1_data,
...
{
  tflite::reference_ops::BatchToSpaceND(unextended_input1_shape, input1_data,
                                        unextended_input2_shape, block_shape_data,
                                        unextended_input3_shape, crops_data,
