...
{
template <typename T>
static inline void SpaceToBatchND(const tflite::SpaceToBatchParams& params,
...
{
  tflite::reference_ops::SpaceToBatchND(params, unextended_input1_shape, input1_data,
                                        unextended_input2_shape, block_shape_data,
                                        unextended_input3_shape, paddings_data,
