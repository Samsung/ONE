...
#ifndef LUCI_INTERPRETER_HAL_CONV2D_H
#define LUCI_INTERPRETER_HAL_CONV2D_H

#include <tensorflow/lite/kernels/internal/optimized/legacy_optimized_ops.h>

namespace luci_interpreter_hal
{
                 ...
                 float* im2col_data)
{
  if (im2col_data)
  {
    tflite::optimized_ops::Conv(
      params, input_shape, input_data, filter_shape,
...
#endif // LUCI_INTERPRETER_HAL_CONV2D_H
