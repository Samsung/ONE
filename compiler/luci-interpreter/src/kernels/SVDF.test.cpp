...
TEST_F(SVDFTest, FullInteger)
{
  ...
  std::vector<float> weight_filter_data{-0.31930989, -0.36118156, 0.0079667,   0.37613347,
  ...
  Tensor weight_feature_tensor = makeInputTensor<DataType::S8>(
    ...
    weight_filter_data, _memory_manager.get());
  ...
  Tensor scratchpad_1(DataType::U8, Shape({}), {}, "");
  Tensor scratchpad_2(DataType::U8, Shape({}), {}, "");
  Tensor scratchpad_3(DataType::U8, Shape({}), {}, "");
  Tensor scratchpad_4(DataType::U8, Shape({}), {}, "");
  Tensor scratchpad_5(DataType::U8, Shape({}), {}, "");
  Tensor scratchpad_6(DataType::U8, Shape({}), {}, "");
