...
void AveragePool2D::evalFloat() const
{
  ...
  tflite::reference_ops::AveragePool(params, convertShape(_input->shape()), _input->data<float>(),
...
void AveragePool2D::evalQuantized() const
{
  ...
  tflite::reference_ops::AveragePool(params, convertShape(_input->shape()), _input->data<uint8_t>(),
