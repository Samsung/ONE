...
void MaxPool2D::evalFloat() const
{
  ...
  tflite::reference_ops::MaxPool(params, convertShape(_input->shape()), _input->data<float>(),
...
void MaxPool2D::evalQuantized() const
{
  ...
  tflite::reference_ops::MaxPool(params, convertShape(_input->shape()), _input->data<uint8_t>(),
