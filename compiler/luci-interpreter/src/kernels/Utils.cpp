...
static void calculateActivationRangeImpl(Activation activation, int32_t qmin, int32_t qmax,
                                       ...
                                       int32_t *activation_min, int32_t *activation_max)
{
  ...
  calculateActivationRangeImpl(activation, qmin, qmax, output, activation_min, activation_max);
}
