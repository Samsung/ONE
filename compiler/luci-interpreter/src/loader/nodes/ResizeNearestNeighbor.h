...
#ifndef LUCI_INTERPRETER_LOADER_NODES_RESIZENEARESTNEIGHBOR_H
#define LUCI_INTERPRETER_LOADER_NODES_RESIZENEARESTNEIGHBOR_H
...
#endif // LUCI_INTERPRETER_LOADER_NODES_RESIZENEARESTNEIGHBOR_H
