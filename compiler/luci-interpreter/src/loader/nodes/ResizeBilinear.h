...
#ifndef LUCI_INTERPRETER_LOADER_NODES_RESIZEBILINEAR_H
#define LUCI_INTERPRETER_LOADER_NODES_RESIZEBILINEAR_H
...
#endif // LUCI_INTERPRETER_LOADER_NODES_RESIZEBILINEAR_H
