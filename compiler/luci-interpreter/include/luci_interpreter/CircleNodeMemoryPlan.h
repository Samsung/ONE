...
public:
  ...
  CircleNodeMemoryPlan(uint32_t order_in_plan, std::vector<uint32_t> offset)
  {
  ...
  std::vector<uint32_t> offset(void) const { return _offset; }
  void offset(const std::vector<uint32_t> offset) { _offset = offset; }
