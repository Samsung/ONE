...
// This macro describes common tasks inside pre-opeartor hook
// After this macro, two variables are created
// 1. hook: Python function called before operator execution (type: py::object)
...
public:
  ...
  {
    if (!py::hasattr(_analysis, "DefaultOpPre"))
      return;
...
#undef PRE_OPERATOR_HOOK_PROLOGUE
};
