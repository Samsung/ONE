...
// This macro describes common tasks inside post-opeartor hook
// Use this macro for hooks for normal Ops (except DefaultOp)
// After this macro, three variables are created
// 1. hook: Python function called after operator execution (type: py::object)
...
public:
  ...
  {
    if (!py::hasattr(_analysis, "DefaultOpPost"))
      return;
...
#undef POST_OPERATOR_HOOK_PROLOGUE
};
