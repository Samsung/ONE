...
#ifndef __CIRCLE_EVAL_DIFF_FILE_DATA_LOADER_H__
#define __CIRCLE_EVAL_DIFF_FILE_DATA_LOADER_H__
...
class HDF5Loader : public InputDataLoader
{
public:
...
#endif // __CIRCLE_EVAL_DIFF_FILE_DATA_LOADER_H__
