...
* @post      The names and shapes of the initializers are stored in an unordered set of NodeTensor objects.
* @exception None
* @return    An unordered set of NodeTensor objects containing the names and shapes of the initializers.
*/
...
* @post      The names and shapes of the inputs, outputs, and value_info are stored in an unordered set of NodeTensor objects.
* @exception None
* @return    An unordered set of NodeTensor objects containing the names and shapes of the inputs, outputs, and value_info.
*/
std::unordered_set<NodeTensor> getIOvalue(const onnx::GraphProto& graph);
/**
* @brief     Determines the input tensors of the graph that are not produced by any node in the graph.
*
* @param     [in] g The ONNX GraphProto object representing the graph.
* @param     [in] initializerNames A set of NodeTensor objects representing the initializers in the graph.
* @param     [out] graphInputs A set of NodeTensor objects representing the input tensors of the graph.
* @pre       The GraphProto object g should be valid and contain nodes with proper input and output lists.
* @post      The graphInputs set will be populated with NodeTensor objects that are inputs to the graph.
* @exception None
* @return    None
*/
...
/**
* @brief     Determines the output tensors of the graph that are either outputs of the original graph or are used as inputs in other parts of the graph.
*
...
* @param     [in] allgraphInputs_1 A vector of sets of NodeTensor objects representing the first set of inputs to the graph.
* @param     [in] allgraphInputs_2 A vector of sets of NodeTensor objects representing the second set of inputs to the graph.
* @param     [out] graphOutputs A set of NodeTensor objects representing the output tensors of the graph.
* @pre       The GraphProto objects originalGraph and g should be valid and contain nodes with proper input and output lists.
* @post      The graphOutputs set will be populated with NodeTensor objects that are outputs of the graph.
* @exception None
* @return    None
*/
...
/**
* @brief     Finds the name of the node that produces a specified output tensor in the given ONNX graph.
*
* @param     [in] g The ONNX GraphProto object representing the graph.
...
* @post      None
* @exception None
* @return    The name of the node that produces the specified output tensor, or an empty string if no such node is found.
*/
...
* @exception Exits the program with an error message if the number of nodes in targetGraph does not match the expected size after merging.
* @return    None
*/
