...
TEST(ShapeRuleTest, strided_slice_dynamic_shape)
{
  luci::CircleInput input;
  luci::CircleConst begin;
  luci::CircleConst end;
...
TEST(ShapeRuleTest, strided_slice_dynamic_shape_2)
{
  luci::CircleInput input;
  luci::CircleConst begin;
  luci::CircleConst end;
