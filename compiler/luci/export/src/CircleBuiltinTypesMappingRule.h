...
public:
#define CIRCLE_NODE(CIRCLE_CLASS, OP, OPTION) \
  circle::BuiltinOperator visit(const CIRCLE_CLASS *) final { return circle::OP; }
// Virtual nodes are not circle builtin operator
#define CIRCLE_VNODE(CIRCLE_CLASS)
...
public:
#define CIRCLE_NODE(CIRCLE_CLASS, OP, OPTION) \
  circle::BuiltinOptions visit(const CIRCLE_CLASS *) final { return circle::OPTION; }
// Virtual nodes are not circle builtin operator
#define CIRCLE_VNODE(CIRCLE_CLASS)
#include "CircleOps.lst"
#undef CIRCLE_VNODE
