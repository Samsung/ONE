...
#ifndef __LUCI_CIRCLFILEEXPCONTRACT_H__
#define __LUCI_CIRCLFILEEXPCONTRACT_H__
...
public:
  loco::Graph *graph(void) const final { return _module != nullptr ? _module->graph() : nullptr; }
...
#endif // __LUCI_CIRCLFILEEXPCONTRACT_H__
