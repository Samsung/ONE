...
public:
  ...
  void init(loco::Graph *g)
  {
    ...
    _split_const = _body_graph->nodes()->create<luci::CircleConst>();
    _split_const->dtype(loco::DataType::S32);
...
public:
  ...
  void init(void)
  {
    ...
    _split_node_1->split_dim(_split_const);
    _split_node_2->input(_fc_node_2);
    _split_node_2->split_dim(_split_const);
