...
class ExtractGeluFromOptFCTestGraph : public TestIOGraph, public FCGeluFCGraphlet
{
public:
  ExtractGeluFromOptFCTestGraph() = default;
...
class ExtractGeluFromOptFCTestNegGraph : public TestIOGraph, public FCGeluFCGraphlet
{
public:
  ExtractGeluFromOptFCTestNegGraph() = default;
...
TEST(ExtractGeluFromOptFCPassTest, basic)
{
  ExtractGeluFromOptFCTestGraph g;
  luci::ExtractGeluFromOptFCPass pass;
...
TEST(ExtractGeluFromOptFCPassTest, fuse_NEG)
{
  ExtractGeluFromOptFCTestNegGraph g;
  luci::ExtractGeluFromOptFCPass pass;
