...
class FindGroupToFollow final : public luci::CircleNodeVisitor<std::string>
{
public:
...
private:
  std::string groupof(const luci::CircleNode *input)
  {
...
#define IMPLEMENT(CLASS)                                             \
  std::string visit(const luci::CLASS *node) final                   \
  {                                                                  \
...
#undef IMPLEMENT
  ...
  std::string visit(const luci::CircleNode *) final { return std::string(); }
