...
{
  auto add = loco::must_cast<const luci::CircleAdd *>(node);
  s.args().append("fused_activation_function", luci::to_str(add->fusedActivationFunction()));
}
                                                  ...
                                                  locop::NodeSummary &s)
{
  ...
  s.args().append("output_type", luci::to_str(argmax->output_type()));
}
                                                  ...
                                                  locop::NodeSummary &s)
{
  ...
  s.args().append("output_type", luci::to_str(argmin->output_type()));
}
...
{
  auto avgpool = loco::must_cast<const luci::CircleAveragePool2D *>(node);
  s.args().append("filter(h,w)", luci::to_str(avgpool->filter()));
  s.args().append("stride(h,w)", luci::to_str(avgpool->stride()));
  s.args().append("padding", luci::to_str(avgpool->padding()));
  s.args().append("fused_activation_function", luci::to_str(avgpool->fusedActivationFunction()));
}
                                                       ...
                                                       locop::NodeSummary &s)
{
  ...
  s.args().append("adj_x", luci::to_str(batchmatmul->adj_x()));
  s.args().append("adj_y", luci::to_str(batchmatmul->adj_y()));
}
...
{
  auto bcq_fc = loco::must_cast<const luci::CircleBCQFullyConnected *>(node);
  s.args().append("fused_activation_function", luci::to_str(bcq_fc->fusedActivationFunction()));
                                                                     ...
                                                                     locop::NodeSummary &s)
{
  ...
  s.args().append("cell_clip", luci::to_str(lstm->cell_clip()));
  s.args().append("proj_clip", luci::to_str(lstm->proj_clip()));
  s.args().append("merge_outputs", luci::to_str(lstm->merge_outputs()));
  s.args().append("time_major", luci::to_str(lstm->time_major()));
  s.args().append("asymmetric_quantize_inputs", luci::to_str(lstm->asymmetric_quantize_inputs()));
}
...
void CircleCastSummaryBuilder::build_attributes(const luci::CircleNode *node, locop::NodeSummary &s)
{
  ...
  s.args().append("in_data_type", luci::to_str(cast->in_data_type()));
  s.args().append("out_data_type", luci::to_str(cast->out_data_type()));
}
                                                         ...
                                                         locop::NodeSummary &s)
{
  ...
  s.args().append("fused_activation_function", luci::to_str(concat->fusedActivationFunction()));
}
...
{
  auto conv2d = loco::must_cast<const luci::CircleConv2D *>(node);
  s.args().append("stride(h,w)", luci::to_str(conv2d->stride()));
  s.args().append("dilation(h,w)", luci::to_str(conv2d->dilation()));
  s.args().append("padding", luci::to_str(conv2d->padding()));
  s.args().append("fused_activation_function", luci::to_str(conv2d->fusedActivationFunction()));
}
...
{
  auto dw_conv2d = loco::must_cast<const luci::CircleDepthwiseConv2D *>(node);
  s.args().append("stride(h,w)", luci::to_str(dw_conv2d->stride()));
  s.args().append("dilation(h,w)", luci::to_str(dw_conv2d->dilation()));
  s.args().append("padding", luci::to_str(dw_conv2d->padding()));
  s.args().append("depthMultiplier", std::to_string(dw_conv2d->depthMultiplier()));
  s.args().append("fused_activation_function", luci::to_str(dw_conv2d->fusedActivationFunction()));
}
                                                     ...
                                                     locop::NodeSummary &s)
{
  ...
  s.args().append("narrow_range", luci::to_str(fake_quant->narrow_range()));
}
...
{
  auto fc = loco::must_cast<const luci::CircleFullyConnected *>(node);
  s.args().append("fused_activation_function", luci::to_str(fc->fusedActivationFunction()));
}
                                                        ...
                                                        locop::NodeSummary &s)
{
  ...
  s.args().append("fused_activation_function", luci::to_str(instnorm->fusedActivationFunction()));
}
...
{
  auto l2norm = loco::must_cast<const luci::CircleL2Normalize *>(node);
  s.args().append("fused_activation_function", luci::to_str(l2norm->fusedActivationFunction()));
}
...
{
  auto l2pool = loco::must_cast<const luci::CircleL2Pool2D *>(node);
  s.args().append("filter(h,w)", luci::to_str(l2pool->filter()));
  s.args().append("stride(h,w)", luci::to_str(l2pool->stride()));
  s.args().append("padding", luci::to_str(l2pool->padding()));
  s.args().append("fused_activation_function", luci::to_str(l2pool->fusedActivationFunction()));
}
...
{
  auto maxpool = loco::must_cast<const luci::CircleMaxPool2D *>(node);
  s.args().append("filter(h,w)", luci::to_str(maxpool->filter()));
  s.args().append("stride(h,w)", luci::to_str(maxpool->stride()));
  s.args().append("padding", luci::to_str(maxpool->padding()));
  s.args().append("fused_activation_function", luci::to_str(maxpool->fusedActivationFunction()));
}
...
{
  auto mirror_pad = loco::must_cast<const luci::CircleMirrorPad *>(node);
  s.args().append("mode", luci::to_str(mirror_pad->mode()));
}
...
{
  auto mul = loco::must_cast<const luci::CircleMul *>(node);
  s.args().append("fused_activation_function", luci::to_str(mul->fusedActivationFunction()));
}
                                                          ...
                                                          locop::NodeSummary &s)
{
  ...
  s.args().append("align_corners", luci::to_str(resize_bilinear->align_corners()));
  s.args().append("half_pixel_centers", luci::to_str(resize_bilinear->half_pixel_centers()));
}
                                                                 ...
                                                                 locop::NodeSummary &s)
{
  ...
  s.args().append("align_corners", luci::to_str(resize_nn->align_corners()));
}
                                                 ...
                                                 locop::NodeSummary &s)
{
  ...
  s.args().append("out_type", luci::to_str(shape->out_type()));
}
                                                   ...
                                                   locop::NodeSummary &s)
{
  ...
  s.args().append("beta", luci::to_str(softmax->beta()));
}
                                                        ...
                                                        locop::NodeSummary &s)
{
  ...
  s.args().append("block_size", luci::to_str(space_to_depth->block_size()));
}
                                                         ...
                                                         locop::NodeSummary &s)
{
  ...
  s.args().append("validate_indices", luci::to_str(sparse_to_dense->validate_indices()));
}
...
{
  auto svdf = loco::must_cast<const luci::CircleSVDF *>(node);
  s.args().append("rank", luci::to_str(svdf->svdf_rank()));
  s.args().append("asymmetric_quantize_inputs", luci::to_str(svdf->asymmetric_quantize_inputs()));
  s.args().append("fused_activation_function", luci::to_str(svdf->fusedActivationFunction()));
}
...
{
  auto transpose_conv = loco::must_cast<const luci::CircleTransposeConv *>(node);
  s.args().append("stride(h,w)", luci::to_str(transpose_conv->stride()));
  s.args().append("padding", luci::to_str(transpose_conv->padding()));
}
                                                  ...
                                                  locop::NodeSummary &s)
{
  ...
  s.args().append("idx_out_type", luci::to_str(unique->idx_out_type()));
}
