...
# This script is to check correctness of mlir generate raw model vs
# processed model, executing source circle and target circle, from circle-impexp,
# with circle-interpreter and compare output results.
#
# HOW TO USE
#
# ./run_mlir_test.sh <path/to/venv_dir> <model>
