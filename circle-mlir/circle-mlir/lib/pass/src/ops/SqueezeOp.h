...
class ConvSqueezeV11 : public mlir::OpConversionPattern<mlir::ONNXSqueezeV11Op>
{
public:
  using mlir::OpConversionPattern<mlir::ONNXSqueezeV11Op>::OpConversionPattern;
  using OpAdaptor = typename mlir::ONNXSqueezeV11Op::Adaptor;

  mlir::LogicalResult matchAndRewrite(mlir::ONNXSqueezeV11Op op, OpAdaptor adaptor,
                                      mlir::ConversionPatternRewriter &rewriter) const override
  {
    throw std::runtime_error("NYI ConvSqueezeV11");
    ...
    rewriter.replaceOpWithNewOp<SqueezeOp>(op, op.getType(), input, op.getAxesAttr());
