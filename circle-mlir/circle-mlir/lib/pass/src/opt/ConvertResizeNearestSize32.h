...
#ifndef __CIRCLE_MLIR_PASS_OPT_CONVERT_RESIZE_NEAREST_SIZE_32_H__
#define __CIRCLE_MLIR_PASS_OPT_CONVERT_RESIZE_NEAREST_SIZE_32_H__
...
// Find INT64 Const sizes of ResizeNearestNeighborOp
//    Const(shape/INT64)-ResizeNearestNeighborOp
// Relace Const(shape/INT64) with Const(shape/INT32)
//    Const(shape/INT32)-ResizeNearestNeighborOp
//    ResizeNearestNeighborOp second input size requires 1D, 2 elements for new H,W
//    if input has 4 elements, we assume it is NHWC and only achieve H and W.
struct ConvertResizeNearestSize32 : public OpRewritePattern<ResizeNearestNeighborOp>
{
  using OpRewritePattern<ResizeNearestNeighborOp>::OpRewritePattern;

  LogicalResult matchAndRewrite(ResizeNearestNeighborOp resize_op,
...
#endif // __CIRCLE_MLIR_PASS_OPT_CONVERT_RESIZE_NEAREST_SIZE_32_H__
