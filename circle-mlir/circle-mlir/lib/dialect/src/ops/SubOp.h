...
#ifndef __CIRCLE_MLIR_DIALECT_OPS_SUB_OP_H__
#define __CIRCLE_MLIR_DIALECT_OPS_SUB_OP_H__
...
bool VerifySubOpShapeConstraints(SubOp op)
{
  ...
  // Allows F32 outputs when the operands have valid shapes,
...
#endif // __CIRCLE_MLIR_DIALECT_OPS_SUB_OP_H__
