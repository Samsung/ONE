...
// from, tensorflow/core/framework/kernel_shape_util.h

#ifndef __CIRCLE_MLIR_DIALECT_UTILS_KERNEL_SHAPE_UTIL_H__
#define __CIRCLE_MLIR_DIALECT_UTILS_KERNEL_SHAPE_UTIL_H__
...
#endif // __CIRCLE_MLIR_DIALECT_UTILS_KERNEL_SHAPE_UTIL_H__
