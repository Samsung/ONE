// Circle.fully_connected with unknown shape to validate dynamic shape inference
module {
  func.func @main_graph(%arg0: tensor<?x4x4xf32>) -> tensor<?x?x?xf32> attributes {
    input_names = ["input"],
    output_names = ["output"]}
  {
    ...
    } : (tensor<?x4x4xf32>, tensor<6x4xf32>, tensor<6xf32>) -> tensor<?x?x?xf32>
