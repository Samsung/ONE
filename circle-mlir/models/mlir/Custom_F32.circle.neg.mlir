func.func @main_graph(%arg0: tensor<1x16x16xf32>) -> tensor<1x16x16xf32> attributes {
  input_names = ["onnx::QuantizeLinear_0"],
  output_names = ["5"]}
{
