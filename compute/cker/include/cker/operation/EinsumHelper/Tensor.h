...
#ifndef __NNFW_CKER_EINSUM_HELPER_TENSOR_H__
#define __NNFW_CKER_EINSUM_HELPER_TENSOR_H__
...
public:
  ...
  typename TTypes<float, NDIMS>::Tensor shaped(const std::vector<int32_t> &new_sizes) const
  {
...
#endif // __NNFW_CKER_EINSUM_HELPER_TENSOR_H__
