...
'''
Testing Sin op when the input is dynamic.
...
# write SIN test. input is `test_input`

# note output shape is used by expected output's shape
model_output = Output("output", "TENSOR_FLOAT32", "{1, 2, 3}")

model.Operation("SIN", test_node_input).To(model_output)

model_input_data = [12.0, 36.1, 2.0, 90, 1.0, 0.012]
model_output_data = [-0.536572918, -0.999599143, 0.909297427, 0.893996664, 0.841470985, 0.011999712]
