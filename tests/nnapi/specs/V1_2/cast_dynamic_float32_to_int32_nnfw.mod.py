...
'''
Testing Cast op when the input is dynamic.
...
# write CAST test. input is `test_input`

# note output shape is used by expected output's shape
model_output = Output("output", "TENSOR_INT32", "{1, 2, 3}")

model.Operation("CAST", test_node_input).To(model_output)

model_input_data = [100.0, 20.0, 3.0, 0.4, 0.999, 1.1]
model_output_data = [100, 20, 3, 0, 0, 1]
