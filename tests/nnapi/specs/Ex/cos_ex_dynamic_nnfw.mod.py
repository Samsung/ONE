...
'''
Testing Cos op when the input is dynamic.
...
# write COS test. input is `test_input`

# note output shape is used by expected output's shape
model_output = Output("output", "TENSOR_FLOAT32", "{1, 2, 3}")

model.Operation("COS_EX", test_node_input).To(model_output)

model_input_data = [12.0, 36.1, 2.0, 90, 1.0, 0.012]
model_output_data = [0.843853959, -0.028311733, -0.416146837, -0.448073616, 0.540302306, 0.999928001]
