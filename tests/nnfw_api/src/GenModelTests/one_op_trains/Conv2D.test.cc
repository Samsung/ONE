...
TEST_F(GenModelTrain, OneOp_Conv2D_Stride)
{
  ...
  _context->addTrainCase(uniformTCD<float>(
    {{{4, 0, -5, 1, 0, 4, -1, 1, -1, -3, 3, -2, -4, 1, -2, 2, 4, -4, 2, 2, 0, 4, -1, -2, 4}},
     {{2, -2, 3, 0,  2, 1, -5, 1,  1,  -1, 1, -3, -1,
       2, -4, 1, -1, 2, 0, 0,  -1, -1, -1, 2, 3}}}, // input dataset
    {{{1, 2, -2, -2, 5, -1, 7, 3, -1, -1, -1, 1, 4, -3, -1, 3, 1, 1}},
     {{1, 1, -2, -1, 3, -1, 1, 1, -2, -1, -1, 1, 1, -2, -2, 1, 4, 1}}}, // expected dataset
    {{9.11482238f}}                                                     // last losses
    ));
  _context->setBackends({"train"});
  // To apply backward to loss, epoch should be >= 2
  _context->setEpoch(3);
