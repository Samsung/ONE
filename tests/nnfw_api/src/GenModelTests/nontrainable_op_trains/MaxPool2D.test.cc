...
//     weight_buf}); int bias = cgen.addTensor({{2}, circle::TensorType::TensorType_FLOAT32,
//     bias_buf}); int conv_output = cgen.addTensor({{1, 3, 3, 2},
//     circle::TensorType::TensorType_FLOAT32}); int output = cgen.addTensor({{1, 3, 3, 2},
//     circle::TensorType::TensorType_FLOAT32}); const auto [padding, stride_w, stride_h, filter_w,
//     filter_h, actfn] = getDefaultPool2DOptions();
...
//     int input = cgen.addTensor({{1, 5, 5, 1}, circle::TensorType::TensorType_FLOAT32});
//     int weight = cgen.addTensor({{1, 3, 3, 1}, circle::TensorType::TensorType_FLOAT32,
//     weight_buf}); int bias = cgen.addTensor({{1}, circle::TensorType::TensorType_FLOAT32,
//     bias_buf}); int conv_output = cgen.addTensor({{1, 3, 3, 1},
//     circle::TensorType::TensorType_FLOAT32}); int output = cgen.addTensor({{1, 3, 3, 1},
//     circle::TensorType::TensorType_FLOAT32}); auto [padding, stride_w, stride_h, filter_w,
//     filter_h, actfn] = getDefaultPool2DOptions();
...
//     weight_buf}); int bias = cgen.addTensor({{2}, circle::TensorType::TensorType_FLOAT32,
//     bias_buf}); int conv_output = cgen.addTensor({{1, 3, 3, 2},
//     circle::TensorType::TensorType_FLOAT32}); int output = cgen.addTensor({{1, 2, 2, 2},
//     circle::TensorType::TensorType_FLOAT32}); auto [padding, stride_w, stride_h, filter_w,
//     filter_h, actfn] = getDefaultPool2DOptions(); stride_w = 2; stride_h = 2; filter_w = 2;
//     filter_h = 2;
...
//   const auto [padding, stride_w, stride_h, filter_w, filter_h, actfn] =
//   getDefaultPool2DOptions();
...
//   const auto [padding, stride_w, stride_h, filter_w, filter_h, actfn] =
//   getDefaultPool2DOptions(); cgen.addOperatorMaxPool2D({{input}, {output}}, padding, stride_w,
