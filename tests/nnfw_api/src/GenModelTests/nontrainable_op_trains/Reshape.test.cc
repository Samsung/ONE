...
//   circle::TensorType::TensorType_FLOAT32}); int shape = cgen.addTensor({{2},
//   circle::TensorType::TensorType_INT32, shape_buf}); int output = cgen.addTensor({{1, 18},
//   circle::TensorType::TensorType_FLOAT32}); cgen.addOperatorConv2D({{input, weight, bias},
//   {conv_output}}, circle::Padding_VALID, 1, 1,
