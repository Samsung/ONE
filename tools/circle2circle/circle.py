...
class QuantizationParametersT(object):
    ...
    def __init__(self):
        ...
        self.details = None  # type: Union[None, CustomQuantizationT, MXQuantizationT]
...
def AttentionOptionsAddLayerIdx(builder, layerIdx):
...
class AttentionOptionsT(object):
    ...
    def _UnPack(self, attentionOptions):
        if attentionOptions is None:
            return
        self.layerIdx = attentionOptions.LayerIdx()

    # AttentionOptionsT
    def Pack(self, builder):
        AttentionOptionsStart(builder)
        AttentionOptionsAddLayerIdx(builder, self.layerIdx)
