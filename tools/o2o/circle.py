...
def QuantizationDetailsCreator(unionType, table):
    ...
    if unionType == QuantizationDetails().MXQuantization:
        return MXQuantizationT.InitFromBuf(table.Bytes, table.Pos)
...
def BuiltinOptionsCreator(unionType, table):
    ...
    if unionType == BuiltinOptions().AttentionOptions:
        return AttentionOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions().RunModelOptions:
        return RunModelOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions().RoPEOptions:
        return RoPEOptionsT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == BuiltinOptions().RmsNormOptions:
        return RmsNormOptionsT.InitFromBuf(table.Bytes, table.Pos)
...
class QuantizationParametersT(object):
    ...
    def __init__(self):
        ...
        self.details = None  # type: Union[None, CustomQuantizationT, MXQuantizationT, BlockwiseQuantizationT]
...
def StablehloCaseOptionsAddBranchSubgraphIndices(builder, branchSubgraphIndices):
    builder.PrependUOffsetTRelativeSlot(
        0, flatbuffers.number_types.UOffsetTFlags.py_type(branchSubgraphIndices), 0)
        ...
        if not stablehloCaseOptions.BranchSubgraphIndicesIsNone():
            if np is None:
                ...
                for i in range(stablehloCaseOptions.BranchSubgraphIndicesLength()):
                    self.branchSubgraphIndices.append(
                        stablehloCaseOptions.BranchSubgraphIndices(i))
            else:
    ...
    def Pack(self, builder):
        if self.branchSubgraphIndices is not None:
            if np is not None and type(self.branchSubgraphIndices) is np.ndarray:
                branchSubgraphIndices = builder.CreateNumpyVector(
                    self.branchSubgraphIndices)
            else:
                StablehloCaseOptionsStartBranchSubgraphIndicesVector(
                    builder, len(self.branchSubgraphIndices))
...
def RunModelOptionsAddLocation(builder, location):
    builder.PrependUOffsetTRelativeSlot(
        0, flatbuffers.number_types.UOffsetTFlags.py_type(location), 0)
...
class AttentionOptions(object):
    ...
    @classmethod
    def GetRootAsAttentionOptions(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)

    @classmethod
    def AttentionOptionsBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf,
                                                    offset,
                                                    b"\x43\x49\x52\x30",
                                                    size_prefixed=size_prefixed)
...
def AttentionOptionsStart(builder):
    builder.StartObject(0)


def AttentionOptionsEnd(builder):
    return builder.EndObject()


class AttentionOptionsT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        ...
        attentionOptions.Init(buf, pos)
        return cls.InitFromObj(attentionOptions)
    ...
    @classmethod
    def InitFromObj(cls, attentionOptions):
        x = AttentionOptionsT()
        x._UnPack(attentionOptions)
        return x

    # AttentionOptionsT
    def _UnPack(self, attentionOptions):
        if attentionOptions is None:
            return

    # AttentionOptionsT
    def Pack(self, builder):
        AttentionOptionsStart(builder)
        attentionOptions = AttentionOptionsEnd(builder)
...
class StableHLOCompositeOptions(object):
    ...
    @classmethod
    def StableHLOCompositeOptionsBufferHasIdentifier(cls,
                                                     buf,
                                                     offset,
                                                     size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf,
...
def StableHLOCompositeOptionsAddDecompositionSubgraphIndex(builder,
                                                           decompositionSubgraphIndex):
...
def StableHLOCompositeOptionsAddCompositeAttributes(builder, compositeAttributes):
    builder.PrependUOffsetTRelativeSlot(
        2, flatbuffers.number_types.UOffsetTFlags.py_type(compositeAttributes), 0)
...
def StableHLOCompositeOptionsAddCompositeAttributesFormat(builder,
        ...
        if not stableHlocompositeOptions.CompositeAttributesIsNone():
            if np is None:
                ...
                for i in range(stableHlocompositeOptions.CompositeAttributesLength()):
                    self.compositeAttributes.append(
                        stableHlocompositeOptions.CompositeAttributes(i))
            else:
    ...
    def Pack(self, builder):
        ...
        if self.compositeAttributes is not None:
            if np is not None and type(self.compositeAttributes) is np.ndarray:
                ...
                StableHLOCompositeOptionsStartCompositeAttributesVector(
                    builder, len(self.compositeAttributes))
        ...
        StableHLOCompositeOptionsAddDecompositionSubgraphIndex(
            builder, self.decompositionSubgraphIndex)
        if self.compositeAttributes is not None:
            StableHLOCompositeOptionsAddCompositeAttributes(builder, compositeAttributes)
        StableHLOCompositeOptionsAddCompositeAttributesFormat(
            builder, self.compositeAttributesFormat)
...
class StablehloShiftLeftOptions(object):
    ...
    @classmethod
    def StablehloShiftLeftOptionsBufferHasIdentifier(cls,
                                                     buf,
                                                     offset,
                                                     size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf,
...
def SubGraphAddDebugMetadataIndex(builder, debugMetadataIndex):
    builder.PrependInt32Slot(6, debugMetadataIndex, -1)
