...
if __name__ == "__main__":
  parser = argparse.ArgumentParser("test_partition.py", description="Example code to partition models")
  ...
  parser.add_argument("--num_runs", type=int, default=10, help="Number of runs (topological orderings)")
