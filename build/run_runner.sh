HALIDE=~/ops/codegen_experiments/halide/Halide/
export Halide_DIR=${HALIDE}/install/lib/cmake/Halide

snap run cmake -DCMAKE_BUILD_TYPE=Debug  ../infra/nncc/
make -j10 circle_codegen
LD_LIBRARY_PATH=${HALIDE}/install/lib/ ./compiler/luci-codegen/src/circle_codegen arithmetic.circle compiled
