...
TEST_F(ReduceProdTest, Reduce_Prod_Float_P)
{
...
{
  onert_micro::test_model::NegTestDataWrongInputTypeReduceProdKernel test_data_kernel;
...
{
  onert_micro::test_model::NegTestDataWrongAxisTypeReduceProdKernel test_data_kernel;
