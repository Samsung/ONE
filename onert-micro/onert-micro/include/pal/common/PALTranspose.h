...
#ifndef ONERT_MICRO_EXECUTE_PAL_TRANSPOSE_COMMON_H
#define ONERT_MICRO_EXECUTE_PAL_TRANSPOSE_COMMON_H
...
void TransposeImpl(const core::TransposeParams &params,
                   ...
                   const core::OMRuntimeShape &unextended_output_shape, T *output_data)
{
  ...
  copyDimsToDesc(core::OMRuntimeShape::extendedShape(N, unextended_input_shape),
                 &input_desc);
  copyDimsToDesc(core::OMRuntimeShape::extendedShape(N, unextended_output_shape),
                 &output_desc);
...
void Transpose(const core::TransposeParams &params,
...
#endif // ONERT_MICRO_EXECUTE_PAL_TRANSPOSE_COMMON_H
