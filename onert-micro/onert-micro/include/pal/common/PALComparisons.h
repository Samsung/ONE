...
#ifndef ONERT_MICRO_EXECUTE_PAL_COMPARISON_H
#define ONERT_MICRO_EXECUTE_PAL_COMPARISON_H
...
{
  const onert_micro::core::OMRuntimeShape output_shape;
  NdArrayDesc<4> desc1;
  NdArrayDesc<4> desc2;
};

inline BroadcastComparison4DSlowCommon
BroadcastComparison4DSlowPreprocess(const onert_micro::core::OMRuntimeShape &unextended_input1_shape,
                                    const onert_micro::core::OMRuntimeShape &unextended_input2_shape,
                                    const onert_micro::core::OMRuntimeShape &unextended_output_shape)
{
  NdArrayDesc<4> desc1;
  NdArrayDesc<4> desc2;
  NdArrayDescsForElementwiseBroadcast(unextended_input1_shape, unextended_input2_shape, &desc1,
                                      &desc2);
  return {onert_micro::core::OMRuntimeShape::extendedShape(4, unextended_output_shape), desc1, desc2};
}
...
inline void BroadcastComparison4DSlowWithScaling(
  const onert_micro::core::ComparisonParams &op_params, const onert_micro::core::OMRuntimeShape &unextended_input1_shape,
  const T *input1_data, const onert_micro::core::OMRuntimeShape &unextended_input2_shape,
  const T *input2_data, const onert_micro::core::OMRuntimeShape &unextended_output_shape,
  bool *output_data, bool F(T, T))
{
...
template <typename T>
inline void ComparisonWithScaling(const onert_micro::core::ComparisonParams &op_params, const int64_t flat_size,
...
#endif // ONERT_MICRO_EXECUTE_PAL_COMPARISON_H
