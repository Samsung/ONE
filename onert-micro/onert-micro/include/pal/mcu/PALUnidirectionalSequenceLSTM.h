...
#ifndef ONERT_MICRO_EXECUTE_PAL_UNIDIRECTIONAL_SEQUENCE_LSTM_H
#define ONERT_MICRO_EXECUTE_PAL_UNIDIRECTIONAL_SEQUENCE_LSTM_H
...
//      {
//        lstm_internal::lstmStep<int8_t, int8_t, int16_t, int32_t>(
//          lstm_struct, lstm_params, &step_info, cell_state_info, output_state_data,
//          cell_state_data, scratch0, scratch1, scratch2, scratch3, runtime_graph);
//        // prepare for the next time step
//        step_info.updateTime();
//      }
...
#endif // ONERT_MICRO_EXECUTE_PAL_UNIDIRECTIONAL_SEQUENCE_LSTM_H
