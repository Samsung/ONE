...
template <typename T>
inline void ReduceGeneric(const T *input_data, const int32_t *input_dims,
                          const int32_t input_num_dims, T *output_data, const int32_t *axis,
                          const int64_t num_axis_dimensions, T init_value,
                          const int32_t output_flat_size, T reducer(const T, const T))
{
