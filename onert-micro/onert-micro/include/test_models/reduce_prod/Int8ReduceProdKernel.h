...
#ifndef ONERT_MICRO_TEST_MODELS_INT8_REDUCE_PROD_KERNEL_H
#define ONERT_MICRO_TEST_MODELS_INT8_REDUCE_PROD_KERNEL_H
...
const unsigned char test_kernel_model_circle[] = {
  ...
  0xda, 0xff, 0xff, 0xff, 0x04, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x32, 0x2e, 0x36, 0x2e,
  0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x06, 0x00,
  ...
  0x04, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x4d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x4e, 0x3c, 0x1b, 0x3f, 0x11, 0x00, 0x00, 0x00,
  ...
  0x04, 0x00, 0x00, 0x00, 0x16, 0x00, 0x00, 0x00, 0x50, 0x72, 0x6f, 0x64, 0x2f, 0x72, 0x65, 0x64,
  ...
  0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x40, 0x74, 0xde, 0x3c, 0x13, 0x00, 0x00, 0x00,
  ...
  0x51, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x51, 0x11, 0x00, 0x00, 0x00, 0x4f, 0x4e, 0x45, 0x2d,
  0x74, 0x66, 0x6c, 0x69, 0x74, 0x65, 0x32, 0x63, 0x69, 0x72, 0x63, 0x6c, 0x65, 0x00, 0x00, 0x00};

const std::vector<int8_t> input_data = {91, 27, -43, 32, 121, 10, 91, 27, -43, 32, 121, 10};
const std::vector<int8_t> reference_output_data = {74, 74};

} // namespace reduce_prod_int8

// ------------------------------------------------------------------------------------------------

class TestDataInt8ReduceProd : public TestDataReduceProdBase<int8_t>
{
public:
  TestDataInt8ReduceProd()
  {
    _input_data = reduce_prod_int8::input_data;
    _reference_output_data = reduce_prod_int8::reference_output_data;
    _test_kernel_model_circle = reduce_prod_int8::test_kernel_model_circle;
  }

  ~TestDataInt8ReduceProd() override = default;
};

} // namespace test_model
} // namespace onert_micro

#endif // ONERT_MICRO_TEST_MODELS_INT8_REDUCE_PROD_KERNEL_H
