...
#ifndef ONERT_MICRO_TEST_MODELS_REDUCE_PROD_KERNEL_BASE_H
#define ONERT_MICRO_TEST_MODELS_REDUCE_PROD_KERNEL_BASE_H
...
template <typename T> class TestDataReduceProdBase : public TestDataBase<T>
{
public:
  TestDataReduceProdBase() = default;
...
#endif // ONERT_MICRO_TEST_MODELS_REDUCE_PROD_KERNEL_BASE_H
