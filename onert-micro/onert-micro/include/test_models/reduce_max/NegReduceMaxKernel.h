...
#ifndef ONERT_MICRO_TEST_MODELS_NEG_REDUCE_MAX_KERNEL_H
#define ONERT_MICRO_TEST_MODELS_NEG_REDUCE_MAX_KERNEL_H
...
#endif // ONERT_MICRO_TEST_MODELS_NEG_REDUCE_MAX_KERNEL_H
