...
#ifndef ONERT_MICRO_TEST_MODELS_REDUCE_MAX_KERNEL_BASE_H
#define ONERT_MICRO_TEST_MODELS_REDUCE_MAX_KERNEL_BASE_H
...
#endif // ONERT_MICRO_TEST_MODELS_REDUCE_MAX_KERNEL_BASE_H
