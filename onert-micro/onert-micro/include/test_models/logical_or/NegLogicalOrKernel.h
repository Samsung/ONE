...
#ifndef ONERT_MICRO_TEST_MODELS_NEG_LOGICAL_OR_KERNEL_H
#define ONERT_MICRO_TEST_MODELS_NEG_LOGICAL_OR_KERNEL_H
...
/*
 * LogicalOr Kernel with inputs type mismatch:
 *
...
class NegTestDataLogicalOrInputsTypeMismatch : public NegTestDataBase
{
public:
  NegTestDataLogicalOrInputsTypeMismatch()
  {
    _test_kernel_model_circle = neg_logical_or_inputs_type_mismatch::test_kernel_model_circle;
  }

  ~NegTestDataLogicalOrInputsTypeMismatch() override = default;
...
#endif // ONERT_MICRO_TEST_MODELS_NEG_LOGICAL_OR_KERNEL_H
