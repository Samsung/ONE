...
#ifndef ONERT_MICRO_TEST_MODELS_LOGICAL_NOT_KERNEL_BASE_H
#define ONERT_MICRO_TEST_MODELS_LOGICAL_NOT_KERNEL_BASE_H
...
public:
  ...
  ~TestDataLogicalNotBase() override = default;
...
#endif // ONERT_MICRO_TEST_MODELS_LOGICAL_NOT_KERNEL_BASE_H
