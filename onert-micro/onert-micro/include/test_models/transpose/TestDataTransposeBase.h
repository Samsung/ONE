...
#ifndef ONERT_MICRO_TEST_MODELS_TRANSPOSE_BASE_H
#define ONERT_MICRO_TEST_MODELS_TRANSPOSE_BASE_H
...
template <typename T> class TestDataTransposeBase : public TestDataBase<T>
{
public:
  TestDataTransposeBase() = default;
...
#endif // ONERT_MICRO_TEST_MODELS_TRANSPOSE_BASE_H
