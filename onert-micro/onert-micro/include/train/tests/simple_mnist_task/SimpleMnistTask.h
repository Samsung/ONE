...
#ifndef ONERT_MICRO_TRAIN_TESTS_SIMPLE_MNIST_TASK_H
#define ONERT_MICRO_TRAIN_TESTS_SIMPLE_MNIST_TASK_H

#include "train/tests/OMTestTrainBase.h"
#include "train/tests/models/simple_mnist_model.h"
#include "train/tests/simple_mnist_task/data/train_input.h"
#include "train/tests/simple_mnist_task/data/train_target.h"
...
template <typename T, typename U = T> class SimpleMnistTask : public OMTestTrainBase<T, U>
{
public:
  SimpleMnistTask()
  {
  ...
  std::vector<T> readTrainInputData(size_t size, size_t offset) final
  {
    ...
    auto *cur_ptr = data::simple_mnist_task_input_data + offset;
  ...
  std::vector<U> readTrainTargetData(size_t size, size_t offset) final
  {
    ...
    auto *cur_ptr = data::simple_mnist_task_target_data + offset;
...
#endif // ONERT_MICRO_TRAIN_TESTS_SIMPLE_MNIST_TASK_H
