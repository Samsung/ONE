...
// acceptable_diff - acceptable difference in metric values in order to select the best result in memory.
// memory_above_restriction - the upper limit of memory that cannot be exceeded
struct TrainData
{
