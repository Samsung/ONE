...
template <>
inline void Mul(const ArithmeticParams &params, const int flat_size, const float *input1_data,
...
// Quantized intermediate tensors
template <>
inline void MulScalar(const ArithmeticParams &params, const int flat_size, const float *input_data,
                   ...
                   luci_interpreter::OperationGraphStatus status)
{
  ...
  {
    return MulScalar(params, flat_size, input2_data, input1_data[0], output_data, status);
  }
