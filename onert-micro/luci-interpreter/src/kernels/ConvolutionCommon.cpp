...
int32_t computePadding(const circle::Tensor *input, const circle::Tensor *filter,
...
luci_interpreter_pal::ConvParams createConvParams(const circle::Tensor *input,
                                                  ...
                                                  const circle::Conv2DOptions *options)
{
  ...
  params.padding_values.height =
    computePadding(input, filter, padding, stride_height, dilation_height_factor, 1);
  params.padding_values.width =
    computePadding(input, filter, padding, stride_width, dilation_width_factor, 2);
